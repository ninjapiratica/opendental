    ...
    public class Statements
    {
        ...
        public static void EmailStatementPatientPortal(Statement stmt, string toAddress, EmailAddress fromAddress, Patient patCur)
        {
            ...
            catch
            {
                ...
                if (fromAddress == null || !EmailAddresses.IsValidEmail(fromAddress.SenderAddress))
                {//Check to make sure that our "from" email address is valid.
            ...
            Dictionary<long, Family> dictFamilies = null)
        {
            ...
            else
            {
                ...
                if (maxStmtsPerBatch == 0 || PrefC.GetString(PrefName.BillingUseElectronic) == "2" || PrefC.GetString(PrefName.BillingUseElectronic) == "4")
                {//Max is disabled or Output to File billing option or using EDS.
