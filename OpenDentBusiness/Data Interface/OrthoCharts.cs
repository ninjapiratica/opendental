    ...
    public class OrthoCharts
    {
        ...
        public static void Sync(Patient patCur, List<OrthoChartRow> listOrthoChartRows, List<OrthoChart> listNew, List<DisplayField> listOrthDisplayFields)
        {
            ...
            while (idxNew < listNew.Count || idxDB < listDB.Count)
            {
                ...
                else if (fieldNew.OrthoChartRowNum < fieldDB.OrthoChartRowNum)
            ...
            {
                if (listIns[i].FieldValue == "")
                {//do not insert new blank values. This happens when fields from today are not used.
                    continue;
                }
                Insert(listIns[i]);
            }
            ...
            {//All logging should have been performed above in the "Update block"
