...
namespace OpenDentBusiness
{
    ...
    public class DiseaseDefs
    {
        ...
        public static long GetDefNumForDefaultPreg(string pregCode)
        {
            long diseaseDefNumPreg = DiseaseDefs.GetNumFromCode(pregCode);//see if the code is attached to a valid diseasedef
            ...
            {//no diseasedef in db for the default code, create and insert def
                ...
                {
                    case "ICD9CM":
                        diseaseDef.ICD9Code = pregCode;
                        break;
                    case "ICD10CM":
                        diseaseDef.Icd10Code = pregCode;
                        break;
                    case "SNOMEDCT":
                        diseaseDef.SnomedCode = pregCode;
                        break;
                }
