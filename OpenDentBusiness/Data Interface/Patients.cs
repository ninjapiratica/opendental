...
namespace OpenDentBusiness
{
    ...
    public class Patients
    {
        ...
        {
            //No need to check MiddleTierRole; no call to db and uses ref parameters.
        ...
        {
            //No need to check MiddleTierRole; no call to db and private method with arguments that act like out parameters.
        ...
        public static DataTable GetPtDataTable(PtTableSearchParams ptSearchArgs)
        {
            ...
            string command = $@"SELECT DISTINCT patient.PatNum,patient.LName,patient.FName,patient.MiddleI,patient.Preferred,patient.Birthdate,patient.SSN,
				...
				patient.PriProv,patient.SiteNum,patient.Email,patient.Country,patient.ClinicNum,patient.SecProv,patient.WirelessPhone,patient.TxtMsgOk,
        ...
        {
            //No need to check MiddleTierRole; private method and no call to db.
        ...
        [Obsolete("Use Patients.GetLimForPats() instead")]
        ...
        public static bool IsPatientHashValid(Patient patient)
        {
            ...
            if (patient.SecurityHash == null)
            {//When a patient is first created through middle tier and not yet refreshed from db, this can be null and should not show a warning triangle.
                return true;
            }
    ...
    public class PatComm : WebTypes.WebBase
    {
        ...
        public string GetReasonCantEmail(CommOptOutType type = 0)
        {
            ...
            if (!EmailAddresses.IsValidEmail(Email, out _))
            {
    ...
    public class PtTableSearchParams
    {
        ...
        public PtTableSearchParams(bool doLimit, string lname, string fname, string phone, string address, bool hideInactive, string city,
            ...
            long initialPatNum = 0, bool showMerged = false, bool hasSpecialty = false, bool hasNextLastVisit = false, bool isFromMobile = false)
        {
