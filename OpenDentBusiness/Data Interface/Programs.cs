...
namespace OpenDentBusiness
{
    ...
    public class Programs
    {
        ...
        public static bool IsEnabledByHq(Program progCur, out string err)
        {
            ...
            if (!retVal && string.IsNullOrWhiteSpace(err))
            {//if the CustErr wasn't set at HQ then we assume a customer is not able to use this program because they are not on support
