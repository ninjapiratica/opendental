...
namespace OpenDentBusiness
{
    ...
    public class Recalls
    {
        ...
        {
            //No need to check MiddleTierRole; no call to db.  Also, listProcStrs is used like an "out" or "ref" parameter.
        ...
        public static void UpdateStatus(long recallNum, long newStatus)
        {
            ...
            if (listRecallStatuses.Contains(newStatus))
            {
                ...
                else if (newStatus == 0 && recall.RecallStatus == statusEmailed)
                {//Text failed, but email already successful.
