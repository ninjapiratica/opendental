...
namespace OpenDentBusiness
{
    ...
    public class BugSubmissionHashes
    {
            ...
            , out long matchedBugSubmissionHashNum, Version submissionVersionOverride = null, bool useConnectionStore = true)
        {
            ...
            if (sub.ListMatchedBugInfos == null)
            {//Not already defined (like in unit test) so query for it.
                DataAction.RunBugsHQ(() =>
                {
            ...
            if (sub.ListPendingFixBugInfos.Count > 1)
            {//There are too many pending bugs and a developer will have to decide which to associate with.
            ...
            if (bugInfo == null)
            {//No previously fixed bugs apply to this submission version.
