...
namespace OpenDentBusiness
{
    ...
    public class DtoObject : IXmlSerializable
    {
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            {
                Obj = TimeSpan.FromTicks((long)serializer.Deserialize(reader2));
            }
        ...
        {//,string strAssembDeprecating) {
            ...
            if (strTypeName.StartsWith("List<"))
            {
                ...
                if (assemb == null)
                {
                    ...
                    if (typeGen == null)
                    {//For assemblies other than OpenDentBusiness, i.e. CodeBase
            ...
            else if (strTypeName == "System.TimeSpan")
            {
                typeObj = typeof(TimeSpan);
            }
            else
            {//system types, OpenDentBusiness, and plugins
