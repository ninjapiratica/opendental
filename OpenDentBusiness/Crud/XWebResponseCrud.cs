    ...
    public class XWebResponseCrud
    {
        ...
        public static List<XWebResponse> TableToList(DataTable table)
        {
            ...
            foreach (DataRow row in table.Rows)
            {
                ...
                xWebResponse.EmailResponse = PIn.String(row["EmailResponse"].ToString());
                xWebResponse.LogGuid = PIn.String(row["LogGuid"].ToString());
            ...
            foreach (XWebResponse xWebResponse in listXWebResponses)
            {
                table.Rows.Add(new object[] {
                    ...
                    POut.Int   ((int)xWebResponse.CCSource),
                                ...
                                xWebResponse.EmailResponse,
                                xWebResponse.LogGuid,
                });
            }
            return table;
        }
        ...
        public static long Insert(XWebResponse xWebResponse, bool useExistingPK)
        {
            ...
            command +=
                ...
                + "'" + POut.String(xWebResponse.EmailResponse) + "',"
                + "'" + POut.String(xWebResponse.LogGuid) + "')";
        ...
        public static void Update(XWebResponse xWebResponse)
        {
            string command = "UPDATE xwebresponse SET "
                ...
                + "EmailResponse        = '" + POut.String(xWebResponse.EmailResponse) + "', "
                + "LogGuid              = '" + POut.String(xWebResponse.LogGuid) + "' "
        ...
        public static bool Update(XWebResponse xWebResponse, XWebResponse oldXWebResponse)
        {
            ...
            {
                if (command != "") { command += ","; }
                command += "EmailResponse = '" + POut.String(xWebResponse.EmailResponse) + "'";
            }
            if (xWebResponse.LogGuid != oldXWebResponse.LogGuid)
            {
                if (command != "") { command += ","; }
                command += "LogGuid = '" + POut.String(xWebResponse.LogGuid) + "'";
            }
            if (command == "")
            {
                return false;
