...
namespace OpenDentBusiness.HL7
{
    ...
    public class EhrVXU
    {
        ...
        private void InitializeVariables()
        {
            ...
            if (PrefC.HasClinicsEnabled && _pat.ClinicNum != 0)
        ...
        private void NK1()
        {
            ...
            {//One NK1 segment for each relationship.
                ...
                else if (relat == GuardianRelationship.Grandfather)
                { //This status is from our older guardian implementation.
                    strRelatCode = "GRD";//Grandparent
                }
                else if (relat == GuardianRelationship.Grandmother)
                { //This status is from our older guardian implementation.
                    strRelatCode = "GRD";//Grandparent
                }
                ...
                else if (relat == GuardianRelationship.Stepmother)
                { //This status is from our older guardian implementation.
                    strRelatCode = "PAR";//parent
                }
                else
        ...
        private string GetAssigningAuthority(string city, string state)
        {
            ...
            else if (st == "NY" && c == "NEWYORK")
            { //NEW YORK NEW YORK
                code = "BAA";//NEW YORK CITY has their own code.
            }
            else if (st == "PA" && c == "PHILADELPHIA")
            ...
            else if (st == "TX" && c == "SANANTONIO")
            { //SAN ANTONIO TEXAS
                code = "TBA";//SAN ANTONIO has their own code.
            }
            else if (st == "TX" && c == "HOUSTON")
            { //HOUSTON TEXAS
