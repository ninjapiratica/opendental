...
namespace OpenDentBusiness
{
    ...
    public class MiscData
    {
        ...
        public static string MakeABackup(string serverName = "", string user = "", string pass = "", bool doVerify = false, bool isAutoBackup = true)
        {
            ...
            {//Will be null when utilizing advanced connection strings.
        ...
        public static T RunFuncOnArchiveDatabase<T>(Func<T> f)
        {
            ...
            if (RemotingClient.MiddleTierRole.In(MiddleTierRole.ClientMT, MiddleTierRole.ServerMT))
            {//May already be behind a remoting role check.
