...
namespace OpenDentBusiness
{
    public class StaticTextFields
    {
        ...
        public static List<StaticTextField> GetForType(SheetTypeEnum sheetType)
        {
            ...
            {
                listFields.RemoveAll(x => x.In(StaticTextField.patientPortalCredentials));
            }
    ...
    public class StaticTextData
    {
            ...
            = new Dictionary<StaticTextField, StaticTextFieldDependency>()
        {
            ...
            {StaticTextField.genderHeShe,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderheshe,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderHimHer,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderhimher,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderHimselfHerself,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderhimselfherself,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderHisHer,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderhisher,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderHisHers,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
            {StaticTextField.genderhishers,StaticTextFieldDependency.Pat | StaticTextFieldDependency.PatNote},
        ...
        private void LoadData(StaticTextFieldDependency staticTextDependencies, Patient pat, Family fam, List<long> listProcCodeNums)
        {
            ...
            {
                if (list == null || (isMiddleTier && list.Count == 0))
