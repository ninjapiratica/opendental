...
namespace OpenDentBusiness
{
    public class PrefC
    {
        ...
        ///<summary>Returns true if the office has a read-only server set up.</summary>
        public static bool HasReadOnlyServer
        {
            get
            {
                return !string.IsNullOrEmpty(ReadOnlyServer.Server) || !string.IsNullOrEmpty(ReadOnlyServer.URI);
            }
        }
