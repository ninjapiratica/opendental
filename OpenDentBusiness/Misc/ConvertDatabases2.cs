        ...
        private static void To6_6_1()
        {
            if (FromVersion < new Version("6.6.1.0"))
            {
                ...
                if (DataConnection.DBtype == DatabaseType.MySql)
                {
                    ...
                    table = Db.GetTable(command);
                    int programNum;
                    if (table.Rows.Count > 0 && table.Rows[0]["Enabled"].ToString() == "0")
                    {//if XDR not enabled
                     //change the defaults
...
'204203105')";
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    if (table.Rows[i]["ClockIn"].ToString() == "0")
                    {//false
                    ...
                    if (table.Rows[i + 1]["ClockIn"].ToString() == "1")
                    {//true
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    if (table.Rows[i]["ClockIn"].ToString() == "1")
                    {//true
                    ...
                    if (table.Rows[i + 1]["ClockIn"].ToString() == "0")
                    {//false
