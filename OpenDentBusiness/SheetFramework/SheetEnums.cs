...
namespace OpenDentBusiness
{
    ...
    public enum SheetTypeEnum
    {
        ...
        ///<summary>26</summary>
        [SheetLayoutAttribute(isDynamic: true, SheetFieldLayoutMode.Ecw, SheetFieldLayoutMode.MedicalPractice)]
        ChartModule,
    ...
    public enum SheetFieldType
    {
        ...
        PatImage,
        ///<Summary>11-Special: Currently only used for ToothChart</Summary>
        Special,
    ...
    ///<summary>For Chart layout. Do not alter existing items in this list, since they are already in our Db as serialized XML.</summary>
