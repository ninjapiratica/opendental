...
namespace OpenDentBusiness.AutoComm
{
    public class PatientPortalInviteTagReplacer : ApptTagReplacer
    {
        ...
        protected override void ReplaceTagsChild(StringBuilder sbTemplate, AutoCommObj autoCommObj, bool isEmail)
        {
            ...
            ReplaceOneTag(sbTemplate, "[UserName]", invite.PatientPortalCredential.GetUserName(), isEmail);
            ReplaceOneTag(sbTemplate, "[Password]", invite.PatientPortalCredential.PlainTextPassword, isEmail);
