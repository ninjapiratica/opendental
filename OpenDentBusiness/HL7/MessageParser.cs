...
namespace OpenDentBusiness.HL7
{
    ...
    public class MessageParser
    {
        ...
        public static void Process(MessageHL7 msg, bool isVerboseLogging)
        {
            ...
            for (int f = 0; f < hl7defmsg.ListHL7DefSegments[pidDefOrder].hl7DefFields.Count; f++)
            ...
            for (int i = 0; i < hl7defmsg.ListHL7DefSegments.Count; i++)
            {
                ...
                for (int j = 0; j < hl7defmsg.ListHL7DefSegments[i].hl7DefFields.Count; j++)
            ...
            for (int i = 0; i < segDef.hl7DefFields.Count; i++)
            {
                ...
                switch (segDef.hl7DefFields[i].FieldName)
                {
                    ...
                    case "pat.HmPhone_V2_3":
                        ...
                        else
                        {
                            ...
                            for (int p = -1; p < phField.ListRepeatFields.Count; p++)
                            {
                                ...
                                {
                                    if (strPhUseCode.ToLower() == "wpn")
                                    {//work phone processed in different field
                                        continue;
                                    }
                                    if (strPhUseCode.ToLower() == "net")
                                    {//set strPhType to Internet if use code is "NET" for V2_3
                                        strPhType = "Internet";
                                    }
                                }
                                switch (strPhType)
                    ...
                    case "pat.Race_V2_3":
                        ...
                        if (strRaceCodeSystem != "CDCREC" && segDef.hl7DefFields[i].FieldName != "pat.Race_V2_3")
                        {//must be eCW, process the old way
                        ...
                        else
                        {
                            ...
                            for (int r = 0; r < fieldRace.ListRepeatFields.Count; r++)
                            {
                                ...
                                if (strRaceCodeSystem == "CDCREC" || segDef.hl7DefFields[i].FieldName == "pat.Race_V2_3")
                                {//CDCREC for CodeSystem is only required if not V2_3
