...
namespace OpenDental
{
    public partial class FormSecurity : FormODBase
    {
        ...
        private void userControlSecurityTabs_AddUserClick(object sender, SecurityEventArgs e)
        {
            ...
            {//update to reflect changes that were made in FormUserEdit.
                userControlSecurityUserGroup.FillGridUsers();//New user is not in grid yet, add them.
                userControlSecurityUserGroup.SelectedUser = formUserEdit.UserCur;//Selects the user that was just added in the grid.
        ...
        private void UserControlSecurityTabs_CopyUserClick(object sender, SecurityEventArgs e)
        {
            ...
            if (!Userods.TryGetUniqueUsername(userod.UserName + "(Copy)", 0, false, false, out string newUserName))
            ...
            Userod userodNew = Userods.CopyUser(userod, formUserPassword.LoginDetails, formUserPassword.PasswordIsStrong, newUserName);
        ...
        private void userControlSecurityTabs_AddUserGroupClick(object sender, SecurityEventArgs e)
        {
            ...
            using FormUserGroupEdit formUserGroupEdit = new FormUserGroupEdit(userGroup);
            formUserGroupEdit.IsNew = true;
            formUserGroupEdit.ShowDialog();
            if (formUserGroupEdit.DialogResult == DialogResult.OK)
            {
        ...
        {
            using FormUserGroupEdit formUserGroupEdit = new FormUserGroupEdit(e.Group);
            formUserGroupEdit.ShowDialog();
            if (formUserGroupEdit.DialogResult == DialogResult.OK)
            {
        ...
        private DialogResult userControlSecurityTabs_AdjustmentTypeDenyPermissionChecked(object sender, SecurityEventArgs e)
        {
            ...
            {//Selected all individual permissions.
