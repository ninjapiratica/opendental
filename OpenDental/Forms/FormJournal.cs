    ...
    public partial class FormJournal : FormODBase
    {
        ...
        private void FillGrid(bool isPrinting = false)
        {
            ...
            for (int i = 0; i < _listJournalEntries.Count; i++)
            {
                ...
                if (string.IsNullOrEmpty(textAmountTo.Text))
                {//The AmountFrom textBox will be treated as an exact amount, not a range.
                ...
                {//AmountTo textBox has a value, treat this as a range.
