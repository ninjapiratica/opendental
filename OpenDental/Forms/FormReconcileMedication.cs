...
namespace OpenDental
{
    public partial class FormReconcileMedication : FormODBase
    {
        ...
        private void butRemoveRec_Click(object sender, EventArgs e)
        {
            ...
            MedicationPat medicationPat;
            for (int i = gridMedReconcile.SelectedIndices.Length - 1; i > -1; i--)
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            {//Start looping through all current medications
                ...
                {//Compare each reconcile medication to the current medication
                    if (medicationPat.RxCui > 0 && medicationPat.RxCui == _listMedicationPatsReconcile[j].RxCui && _listMedicationPatsReconcile[j].MedicationNum == _listMedicationPats[i].MedicationNum)
