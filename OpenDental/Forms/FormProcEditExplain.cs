...
namespace OpenDental
{
    public partial class FormProcEditExplain : FormODBase
    {
        ...
        public bool HasDpcChange;
        private bool _hasRadioChange;
        ...
        public static string GetChanges(Procedure procCur, Procedure procOld, OrionProc orionProcCur, OrionProc orionProcOld)
        {
            ...
            {
                if (Changes != "") { Changes += "\r\n"; }
                string[] stringArrayStatus2 = new string[2];
                string[] stringArrayStatus2Desc = new string[2];
                stringArrayStatus2[0] = orionProcOld.Status2.ToString();
                stringArrayStatus2[1] = orionProcCur.Status2.ToString();
                for (int i = 0; i < 2; i++)
                {
                    switch (stringArrayStatus2[i])
                    {
                        case "None": stringArrayStatus2Desc[i] = "TP-treatment planned"; break;
                        case "TP": stringArrayStatus2Desc[i] = "TP-treatment planned"; break;
                        case "C": stringArrayStatus2Desc[i] = "C-completed"; break;
                        case "E": stringArrayStatus2Desc[i] = "E-existing prior to incarceration"; break;
                        case "R": stringArrayStatus2Desc[i] = "R-refused treatment"; break;
                        case "RO": stringArrayStatus2Desc[i] = "RO-referred out to specialist"; break;
                        case "CS": stringArrayStatus2Desc[i] = "CS-completed by specialist"; break;
                        case "CR": stringArrayStatus2Desc[i] = "CR-completed by registry"; break;
                        case "CA_Tx": stringArrayStatus2Desc[i] = "CA_Tx-cancelled, tx plan changed"; break;
                        case "CA_EPRD": stringArrayStatus2Desc[i] = "CA_EPRD-cancelled, eligible parole"; break;
                        case "CA_P/D": stringArrayStatus2Desc[i] = "CA_P/D--cancelled, parole/discharge"; break;
                        case "S": stringArrayStatus2Desc[i] = "S-suspended, unacceptable plaque"; break;
                        case "ST": stringArrayStatus2Desc[i] = "ST-stop clock, multi visit"; break;
                        case "W": stringArrayStatus2Desc[i] = "W-watch"; break;
                        case "A": stringArrayStatus2Desc[i] = "A-alternative"; break;
                        default: stringArrayStatus2Desc[i] = "error"; break;
                    }
                }
                Changes += "Orion Procedure Status changed from " + stringArrayStatus2Desc[0] + " to " + stringArrayStatus2Desc[1] + ".";
            }
            //Other orion fields----------------------------------------------------------------------------------------------------------------------------
            ...
            //}
            if (procOld.Note != procCur.Note && !(procOld.Note == null && procCur.Note == ""))
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            if (groupBoxDPC.Enabled && !_hasRadioChange)
            {
            ...
            if (_hasRadioChange)
            {
                if (!radioButtonOther.Checked)
                {
                    ...
                    Explanation += "DPC change due to: " + _radioText;
                }
            }
