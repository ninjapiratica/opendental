...
namespace OpenDental
{
    public partial class FormAdvertisingPatientList : FormODBase
    {
        ...
        private DataTable GetPatientDataTable()
        {
            ...
            if (checkUserQuery.Checked)
            { //If we are using a custom query, return a DataTable based on those patnums
            ...
            {//If we are using a standard filter, use the generic query
