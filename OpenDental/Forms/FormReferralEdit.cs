...
namespace OpenDental
{
    ...
    public partial class FormReferralEdit : FormODBase
    {
        ...
        private void FormReferralEdit_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsNew && !Security.IsAuthorized(Permissions.ReferralEdit, true))
            {//User may have add permissions but may not have access to edit.
        ...
        {
            if (!IsNew && !Security.IsAuthorized(Permissions.ReferralEdit))
            {//User may have add permissions but may not have access to edit.
                return;
            }
