...
namespace OpenDental
{
    ...
    public partial class FormDisplayFieldCategories : FormODBase
    {
        ...
        private void FormDisplayFields_Load(object sender, EventArgs e)
        {
            ...
            {
                if (listDisplayFieldCategories[i] == DisplayFieldCategory.None)
                ...
                if (listDisplayFieldCategories[i] == DisplayFieldCategory.OrthoChart)
        ...
        private void ShowCategoryEdit()
        {
            ...
            if (displayFieldCategorySelected == DisplayFieldCategory.None)
            {//should never happen.
                return;
            }
