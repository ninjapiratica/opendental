...
namespace OpenDental
{
    ...
    public partial class FormRefAttachEdit : FormODBase
    {
        ...
        private void FormRefAttachEdit_Load(object sender, EventArgs e)
        {
            ...
            {//either not displaying the Referral field or no description entered, default to 'Referral (other)'
        ...
        private void butChangeReferral_Click(object sender, EventArgs e)
        {
            ...
            RefAttachCur.ReferralNum = formReferralSelect.ReferralSelected.ReferralNum;
        ...
        private void butPickProv_Click(object sender, EventArgs e)
        {
            ...
            comboProvNum.SelectedIndex = Providers.GetIndex(formProviderPick.ProvNumSelected);
