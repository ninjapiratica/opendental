...
namespace OpenDental
{
    ...
    public partial class FormDefEdit : FormODBase
    {
        ...
        private void checkNoColor_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {//Reset to empty color to tell the user the color is disabled.
        ...
        private void butDelete_Click(object sender, EventArgs e)
        {
            ...
            {//deleting an auto note category currently in use will uncategorize those auto notes, refresh cache
        ...
        private void butOK_Click(object sender, System.EventArgs e)
        {
            ...
            switch (_def.Category)
            {
                ...
                case DefCat.PaySplitUnearnedType:
                    ...
                    if (_def.DefNum.ToString() == pref.ValueString && checkHidden.Checked)
                    {//If the current selected Def is the default, and we're setting to hidden, set the new default to the first 'shown' Def
