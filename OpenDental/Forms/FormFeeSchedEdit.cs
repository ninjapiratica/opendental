...
namespace OpenDental
{
    ...
    public partial class FormFeeSchedEdit : FormODBase
    {
        ...
        private void FormFeeSchedEdit_Load(object sender, System.EventArgs e)
        {
            ...
            {//HQ clinic, let them change if a fee sched can be localized or not.
        ...
        {
            if (checkIsGlobal.Checked)
            {//Checking IsGlobal (They want to delete their local fees for the feeschedule and use the HQ ones)
            ...
            {//Unchecking IsGlobal (They want to create local fees for the feeschedule and override the HQ ones)
        ...
        private void checkIsHidden_Click(object sender, EventArgs e)
        {
            ...
            if (listInsPlansForFeeSched.Count > 0)
            {
                string insPlanMsg = Lan.g(this, "This fee schedule is tied to") + " "
                    + listInsPlansForFeeSched.Count + " " + Lan.g(this, "insurance plans.") + " " + Lan.g(this, "Continue?");
            ...
            if (patsUsingFee != "")
            {
                using MsgBoxCopyPaste msgBoxCopyPaste = new MsgBoxCopyPaste(Lan.g(this, "Cannot hide. Fee schedule currently in use by the following non-deleted patients")
                    + ":\r\n" + patsUsingFee);
