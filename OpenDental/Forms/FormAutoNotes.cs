...
namespace OpenDental
{
    ...
    public partial class FormAutoNotes : FormODBase
    {
        ...
        private void treeNotes_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (treeNodeDestination == null || !(treeNodeDestination.Tag is Def || treeNodeDestination.Tag is AutoNote))
            {//moving to root node (category 0)
                if (treeNodeSource.Parent == null)
                {//already at the root node, nothing to do
                    return;
                }
            ...
            {//moving to another folder (category)
        ...
        private void butAdd_Click(object sender, System.EventArgs e)
        {
            ...
            AutoNoteL.FillListTree(treeNotes, _userOdPref);
            if (formAutoNoteEdit.AutoNoteCur != null && formAutoNoteEdit.AutoNoteCur.AutoNoteNum > 0)
            {//select the newly added note in the tree
