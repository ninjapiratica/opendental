...
namespace OpenDental
{
    ...
    public partial class FormPath : FormODBase
    {
        ...
        {
            if (radioDatabaseStorage.Checked && PrefC.AtoZfolderUsed != DataStorageType.InDatabase)
        ...
        private void butOK_Click(object sender, System.EventArgs e)
        {
            ...
            if (OpenDentBusiness.FileIO.FileAtoZ.LocalAtoZpath != textLocalPath.Text)
