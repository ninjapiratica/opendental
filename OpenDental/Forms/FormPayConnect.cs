...
namespace OpenDental
{
    public partial class FormPayConnect : FormODBase
    {
        ...
        private bool VerifyData()
        {
            ...
            {//if the user selected a new CC, verify through PayConnect
             //using a new CC and the card number entered contains something other than digits
                ...
                if (!PayConnect.IsValidCardAndExp(textCardNumber.Text, _expYear, _expMonth, x => MessageBox.Show(x)))
            ...
            if (textNameOnCard.Text.Trim() == "" && _patient != null)
        ...
        private bool ProcessPaymentWebService(int expYear, int expMonth)
        {
            ...
            if (_transResponse == null || _transResponse.Status.code != 0)
