...
namespace OpenDental
{
    ...
    public partial class FormProgramLinkEdit : FormODBase
    {
        ...
        private void FillGrid()
        {
            ...
            {
                if (listProgramProperties[i].PropertyDesc.In("Disable Advertising", "Disable Advertising HQ", ProgramProperties.PropertyDescs.ClinicHideButton))
                {//Don't display in grid
                    continue;
                }
                row = new GridRow();
        ...
        private void ShowPLButHiddenLabel()
        {
            ...
            if (PrefC.HasClinicsEnabled && !listProgramProperties.IsNullOrEmpty())
            {//If anything is in list, they have a hidden clinic.
