    ...
    public partial class FormDomainUserPick : FormODBase
    {
        ...
        private void FillGrid()
        {
            ...
            for (int i = 0; i < searchResultCollection.Count; i++)
            {
                ...
                {
                    if (searchResultCollection[i].Properties.Contains(_stringArrayFields[j]))
                    { //some accounts may not have userPrincipalName if they were created before Windows 2000
