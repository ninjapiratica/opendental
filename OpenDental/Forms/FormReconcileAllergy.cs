    ...
    public partial class FormReconcileAllergy : FormODBase
    {
        ...
        private void FormReconcileAllergy_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ListAllergiesNew.Count; i++)
            {
                ...
                for (int j = 0; j < _listAllergyDefs.Count; j++)
                {
                    ...
                    //	break;
                    //}
                    if (_listAllergyDefs[j].MedicationNum == ListAllergyDefsNew[i].MedicationNum)
        ...
        private void butAddExist_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < gridAllergyExisting.SelectedIndices.Length; i++)
            {
                ...
                for (int j = 0; j < _listAllergiesReconcile.Count; j++)
                {
                    if (!_listAllergiesReconcile[j].IsNew && _listAllergiesReconcile[j].AllergyNum == allergy.AllergyNum)
        ...
        private void butRemoveRec_Click(object sender, EventArgs e)
        {
            ...
            Allergy allergy;
            for (int i = gridAllergyReconcile.SelectedIndices.Length - 1; i > -1; i--)
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            {//Start looping through all current allergies
                ...
                {//Compare each reconcile allergy to the current allergy
                    ...
                    if (_listAllergiesReconcile[j].AllergyDefNum == _listAllergies[i].AllergyDefNum)
                    ...
                    //	break;
                    //}
                    if (allergyDefCur.MedicationNum != 0 && allergyDefCur.MedicationNum == allergyDef.MedicationNum)
