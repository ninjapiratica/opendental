...
namespace OpenDental
{
    ...
    public partial class FormDiseaseDefs : FormODBase
    {
        ...
        private List<DiseaseDef> FilterListByTerms(List<DiseaseDef> listDiseaseDefs, string filterText, SearchTypes searchType)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < listDiseaseDefs.Count; i++)
                {
                    ...
                    if (doFiltersMatch && !listDiseaseDefsFiltered.Contains(listDiseaseDefs[i]))
                    {//Every filter item matches something in the disease's ICD9Code field.
        ...
        private List<DiseaseDef> FilterList()
        {
            ...
            {//use the result list from above and further filter it based on the whether it's hidden or not.
        ...
        private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (formDiseaseDefEdit.DiseaseDefCur == null)
            {//User deleted the DiseaseDef.
