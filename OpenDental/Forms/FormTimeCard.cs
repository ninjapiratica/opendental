    ...
    public partial class FormTimeCard : FormODBase
    {
        ...
        private void FillMain(bool fromDB)
        {
            ...
            else
            {
                ...
                textRateThree.Text = rate3span.ToStringHmm();
                ...
                textRateThree2.Text = rate3span.TotalHours.ToString("n");
        ...
        private void pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            yPos += 16;
            g.DrawString(Lan.g(this, "Rate 3 Time") + ": " + textRateThree.Text + " (" + textRateThree2.Text + ")", fontHeader, brush, xPos, yPos);
            yPos += 16;
        ...
        private void SaveNoteToDb()
        {
            ...
            if (_timeAdjustNote.TimeAdjustNum == 0)
