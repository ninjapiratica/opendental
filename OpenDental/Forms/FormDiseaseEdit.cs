...
namespace OpenDental
{
    ...
    public partial class FormDiseaseEdit : FormODBase
    {
        ...
        private void FormDiseaseEdit_Load(object sender, EventArgs e)
        {
            ...
            if (_disease.SnomedProblemType == "404684003")
            {//Finding
                comboSnomedProblemType.SelectedIndex = 1;
            }
            else if (_disease.SnomedProblemType == "409586006")
            {//Complaint
                comboSnomedProblemType.SelectedIndex = 2;
            }
            else if (_disease.SnomedProblemType == "282291009")
            {//Diagnosis
                comboSnomedProblemType.SelectedIndex = 3;
            }
            else if (_disease.SnomedProblemType == "64572001")
            {//Condition
                comboSnomedProblemType.SelectedIndex = 4;
            }
            else if (_disease.SnomedProblemType == "248536006")
            {//FunctionalLimitation
                comboSnomedProblemType.SelectedIndex = 5;
            }
            else if (_disease.SnomedProblemType == "418799008")
            {//Symptom
