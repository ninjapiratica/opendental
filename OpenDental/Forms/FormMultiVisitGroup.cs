...
namespace OpenDental
{
    public partial class FormMultiVisitGroup : FormODBase
    {
        ...
        {
            Changed = true;
            if (gridGroupedProcs.ListGridRows.Count - gridGroupedProcs.SelectedIndices.Length == 1)
            {//One is not selected
            ...
            for (int i = 0; i < longArrayProcNumsSelected.Length; i++)
            {
                ...
                {//Could have been already ungrouped in another window/pc, possibly
            ...
            for (int i = 0; i < listClaims.Count; i++)
            {
                ...
                else
                {
                    ...
                    { //If this claim isn't primary, we need to see if a primary one is also attached to this procedure
                        ...
                        { //If a primary claim is also attached
