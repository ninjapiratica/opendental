...
namespace OpenDental
{
    public partial class FormMedLabEdit : FormODBase
    {
        ...
        {
            if (PatCur == null)
            {//the MedLab object(s) are not attached to a patient, clear all pat fields
                textPatID.Text = "";
                textPatLName.Text = "";
                textPatFName.Text = "";
                textPatMiddleI.Text = "";
        ...
        private void butPDF_Click(object sender, EventArgs e)
        {
            ...
            if (PatCur.PatNum > 0 && _medLab.PatNum != PatCur.PatNum)
        ...
        private void MoveLabsAndImagesHelper()
        {
            ...
            {//will never be > 0 if storing images in the db
