...
namespace OpenDental
{
    ...
    public partial class FormClearinghouses : FormODBase
    {
        ...
        private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (formClearinghouseEdit.ClearinghouseCur == null)
            {//Clearinghouse was deleted.  Can only be deleted when HQ selected.
                _listClearinghousesHq.RemoveAt(e.Row); //no need to update the nonHq list.
            }
            else
            { //Not deleted.  Both the non-HQ and HQ lists need to be updated.
        ...
        private void FormClearinghouses_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                if (clearinghouseDent.Eformat == ElectronicClaimFormat.x837_5010_med_inst)
                {//mismatch
            ...
            {
                if (clearinghouseMed.Eformat != ElectronicClaimFormat.x837_5010_med_inst)
                {//mismatch
