...
namespace OpenDental
{
    public partial class FormTsiHistory : FormODBase
    {
        ...
        private void FormTsiHistory_Load(object sender, EventArgs e)
        {
            ...
            {
                Family fam = Patients.GetFamily(FormOpenDental.PatNumCur);
                textPatient.Text = fam.GetNameInFamLF(FormOpenDental.PatNumCur);
        ...
        private void FillGrid()
        {
            ...
            {//row was selected before call to FillGrid
                if (rowToReselect > -1)
                {
        ...
        private void gridMain_CellClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (_selectedLog.TransType == TsiTransType.Agg)
        ...
        private void butFind_Click(object sender, EventArgs e)
        {
            ...
            Family fam = Patients.GetFamily(FormPS.PatNumSelected);
            textPatient.Text = fam.GetNameInFamLF(FormPS.PatNumSelected);
            _listSelectedFamPatNums = fam.ListPats.Select(x => x.PatNum).ToList();
            FillGrid();
        }
