...
namespace OpenDental
{
    ...
    public partial class FormApptRules : FormODBase
    {
        ...
        {
            using FormApptRuleEdit formApptRuleEdit = new FormApptRuleEdit(_listAppointmentRules[e.Row]);
        ...
        private void butAdd_Click(object sender, System.EventArgs e)
        {
            ...
            using FormApptRuleEdit formApptRuleEdit = new FormApptRuleEdit(appointmentRule);
            formApptRuleEdit.IsNew = true;
            formApptRuleEdit.ShowDialog();
            if (formApptRuleEdit.DialogResult == DialogResult.Cancel)
            {
                return;
            }
            FillGrid();
