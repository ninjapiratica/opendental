...
namespace OpenDental
{
    public partial class FormSheetFieldComboBox : FormODBase
    {
        ...
        private void listComboType_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            if (listComboType.SelectedItem.ToString() == "General")
            {//General
            ...
            if (listComboType.SelectedItem.ToString() == "Gender Identity")
            {//Gender Identity
                string[] enumVals = Enum.GetNames(typeof(GenderId));
                listboxComboOptions.Items.AddList(enumVals, x => x.ToString());
            }
            else if (listComboType.SelectedItem.ToString() == "Sexual Orientation")
            {//Sexual Orientation
                string[] enumVals = Enum.GetNames(typeof(SexOrientation));
                listboxComboOptions.Items.AddList(enumVals, x => x.ToString());
            }
            else if (listComboType.SelectedItem.ToString() == "Patient Race")
            {//Patient Race
                string[] enumVals = Enum.GetNames(typeof(PatientRaceOld));
                listboxComboOptions.Items.AddList(enumVals, x => x.ToString());
            }
            else if (listComboType.SelectedItem.ToString() == "Patient Grade")
            {//Patient Grade
                string[] enumVals = Enum.GetNames(typeof(PatientGrade));
                listboxComboOptions.Items.AddList(enumVals, x => x.ToString());
            }
            else if (listComboType.SelectedItem.ToString() == "Urgency")
            {//Urgency
