...
namespace OpenDental
{
    ...
    public partial class FormRecallSetup : FormODBase
    {
        ...
        private void FillManualRecall()
        {
            ...
            {//For UI display when we store a zero/meaningless value as -1, for this field we want "".
                textDaysPast.Text = "";
            }
            else
            {
            ...
            if (PrefC.GetLong(PrefName.RecallMaxNumberAutoReminders) == -1)
            {//For UI display when we store a zero/meaningless value as -1, for this field we want "" to display.
        ...
        private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (isHtmlTemplate)
            {
                ...
                formEmailEdit.MarkupText = PrefC.GetString(prefName);
            ...
            newPrefValue = formRecallMessageEdit.MessageVal;
            Prefs.UpdateString(prefName, newPrefValue);
            FillGrid();
        }
        ...
        private void butOK_Click(object sender, System.EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(textMaxAutoReminders.Text))
            {//""= infinite, 0=disabled;
