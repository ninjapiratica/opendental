    ...
    public partial class FormMedPat : FormODBase
    {
        ...
        private void FormMedPat_Load(object sender, System.EventArgs e)
        {
            ...
            {//United States
                ...
                if (Erx.IsFromErx(MedicationPatCur.ErxGuid))
                {//This is a medical order that was automatically created when fetching prescriptions from eRx.
            ...
            {//Probably a medical order created during eRx prescription fetching, but not necessarily.
