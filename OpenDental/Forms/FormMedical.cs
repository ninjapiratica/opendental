...
namespace OpenDental
{
    ...
    public partial class FormMedical : FormODBase
    {
        ...
        private void FormMedical_Load(object sender, EventArgs e)
        {
            ...
            {
                if (listEhrNotPerformeds[i].CodeValue != "428191000124101")
        ...
        private void FillMeds(bool isForPrinting = false)
        {
            ...
            GridColumn col;
            if (CDSPermissions.GetForUser(Security.CurUser.UserNum).ShowInfobutton && !isForPrinting)
            ...
            for (int i = 0; i < _listMedicationPats.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (medicationGeneric.MedicationNum != _listMedicationPats[i].MedicationNum)
                    {//not generic
        ...
        private void gridMeds_CellClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (medicationPat.MedicationNum == 0)
            {//Medication orders returned from NewCrop
        ...
        private void gridMeds_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
                ...
                && CDSPermissions.GetForUser(Security.CurUser.UserNum).MedicationCDS)
            {
                ...
                if (formMedPat.MedicationPatCur.MedicationNum > 0)
                {//0 indicats the med is from NewCrop.
                ...
                else if (formMedPat.MedicationPatCur.RxCui > 0)
                {//Meds from NewCrop might have a valid RxNorm.
        ...
        private void butAddProblem_Click(object sender, EventArgs e)
        {
            ...
            using FormDiseaseDefs formDiseaseDefs = new FormDiseaseDefs(listDiseaseDefNums);
        ...
        private void gridDiseases_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            using FormDiseaseEdit formDiseaseEdit = new FormDiseaseEdit(_listDiseases[e.Row]);
        ...
        private void TobaccoUseTabLoad()
        {
            ...
            for (int i = 0; i < listEventCodesOrderBy.Count; i++)
            {
                ...
                if (snomed == null)
                {//don't add invalid SNOMEDCT codes
                    continue;
                }
        ...
        private void comboSmokeStatus_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < gridAssessments.ListGridRows.Count; i++)
            {
                ...
                if (ehrMeasureEvent.DateTEvent.Date == dateTEntered.Date)
                {//one already exists for this date, don't auto insert event
                    return;
                }
            }
        ...
        private void comboTobaccoStatus_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            {//user selected a code in the list, just return
                return;
            }
            if (comboTobaccoStatus.SelectedIndex == _listEhrCodesTobaccoStatuses.Count
        ...
        private void radioInterventions_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {//if not checked, do nothing, caused by another radio button being checked
                return;
            }
        ...
        private void butIntervention_Click(object sender, EventArgs e)
        {
            ...
            if (ehrCode.CodeSystem == "RXNORM" && !checkPatientDeclined.Checked)
            {//if patient declines the medication, enter as a declined intervention
