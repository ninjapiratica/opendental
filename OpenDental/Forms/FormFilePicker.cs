...
namespace OpenDental
{
    public partial class FormFilePicker : FormODBase
    {
        ...
        private void butPreview_Click(object sender, EventArgs e)
        {
            ...
            if (!gridMain.ListGridRows[gridMain.GetSelectedIndex()].Cells[0].Text.Contains("."))
            {//File path doesn't contain an extension and thus is a subfolder.
                return;
            }
        ...
        private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (gridMain.ListGridRows[gridMain.GetSelectedIndex()].Cells[0].Text.Contains("."))
            {//They selected a file because there is an extension.
