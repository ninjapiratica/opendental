...
namespace OpenDental
{
    ...
    public partial class FormDocInfo : FormODBase
    {
        ...
        public void FormDocInfo_Load(object sender, System.EventArgs e)
        {
            ...
            else if (!Security.IsAuthorized(Permissions.ImageEdit, _documentOld.DateCreated, suppressMessage: true))
            {
                butOK.Enabled = false;
            }
            if (IsMountItem)
        ...
        private void butOK_Click(object sender, System.EventArgs e)
        {
            ...
            if (dateTimeEntered > _document.DateCreated)
            {
                ...
                if (!Security.IsAuthorized(Permissions.ImageDelete, _document.DateCreated, suppressMessage: true))
                {
            ...
            {
                ImageStore.LogDocument(Lan.g(this, "Document Edited") + ": ", Permissions.ImageEdit, _document, _documentOld.DateTStamp);
            }
