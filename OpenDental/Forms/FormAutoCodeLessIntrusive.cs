...
namespace OpenDental
{
    ...
    public partial class FormAutoCodeLessIntrusive : FormODBase
    {
        ...
        ///<summary></summary>
        public FormAutoCodeLessIntrusive(Patient patient, Procedure procedure, ProcedureCode procedureCode, long verifyCodeNum, List<PatPlan> listPatPlans,
        ...
        private void butYes_Click(object sender, System.EventArgs e)
        {
            ...
            if (listProcStats.Contains(ProcedureCur.ProcStatus))
            ...
            {
                strLogText += Lan.g(this, "Teeth") + ": " + _strTeeth + ", ";
            }
            strLogText += Lan.g(this, "Fee") + ": " + ProcedureCur.ProcFee.ToString("F") + ", " + _procedureCode.Descript;
