...
class DataGridViewPrinter
{
    ...
    private void DrawHeader(Graphics g)
    {
        ...
        for (int i = (int)_listIntArraysColumnPoints[_columnPoint].GetValue(0); i < (int)_listIntArraysColumnPoints[_columnPoint].GetValue(1); i++)
        {
            ...
            if (_dataGridView.RowHeadersBorderStyle != DataGridViewHeaderBorderStyle.None)
    ...
    private bool DrawRows(Graphics g)
    {
        ...
        {
            if (_dataGridView.Rows[_currentRow].Visible)
            { // Print the cells of the CurrentRow only if that row is visible
                ...
                for (int c = (int)_listIntArraysColumnPoints[_columnPoint].GetValue(0); c < (int)_listIntArraysColumnPoints[_columnPoint].GetValue(1); c++)
                {
                    ...
                    // Drawing the cell bounds
                    if (_dataGridView.CellBorderStyle != DataGridViewCellBorderStyle.None)
        ...
        if (_columnPoint == _listIntArraysColumnPoints.Count)
