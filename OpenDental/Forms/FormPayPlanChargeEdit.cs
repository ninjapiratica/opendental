...
namespace OpenDental
{
    ...
    public partial class FormPayPlanChargeEdit : FormODBase
    {
        ...
        public FormPayPlanChargeEdit(PayPlanCharge payPlanCharge, PayPlan payPlan)
        {
            ...
            _payPlan = payPlan;
            Lan.F(this);
            if (PayPlanChargeCur.Principal < 0)
            {//only adjustments are allowed to be negative. 
        ...
        private void FormPayPlanCharge_Load(object sender, System.EventArgs e)
        {
            ...
            if (!CompareDouble.IsZero(_payPlan.APR))
            {
                ...
                {
                    string logText = Lan.g(this, (_payPlan.PlanNum == 0 ? "Patient" : "Insurance") + " Payment Plan Charge with amount due of")
                ...
                {//User does not have the PayPlanChargeDateEdit permission
