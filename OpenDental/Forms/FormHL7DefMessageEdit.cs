...
namespace OpenDental
{
    ...
    public partial class FormHL7DefMessageEdit : FormODBase
    {
        ...
        private void FormHL7DefMessageEdit_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < Enum.GetNames(typeof(MessageStructureHL7)).Length; i++)
            {//start at enum 1, 0 is NotDefined and is not displayed for user to select.  Used for unsupported message structures
