...
namespace OpenDental
{
    public partial class FormApptPrintSetup : FormODBase
    {
        ...
        private void FormApptPrintSetup_Load(object sender, EventArgs e)
        {
            ...
            {//Hide if clinics is enabled and headquarters is selected
                groupBoxPrintRouting.Enabled = false;
            }
            if (_isWeeklyView)
            { //Disable if the user has the weekly view selected in the appt module
                groupBoxPrintRouting.Enabled = false;
            }
        }
        ...
        private bool ValidEntries()
        {
            ...
            if (dateStop.Hour != 0 && dateStop.Hour < dateStart.Hour)
