    ...
    public partial class FormWebMailMessageEdit : FormODBase
    {
        ...
        private void FormWebMailMessageEdit_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (_listPatsForPHI.Count == 0)
                {//Every patient should have at least one guarantor.
        ...
        private void FillFields()
        {
            ...
            {//An existing email has been passed in.
        ...
        {
            if (_webMailMode != WebMailMode.View)
            {//If in view mode, do not enable preview and send buttons.
                AllowSendMessages();
            }
            if (_patCur.Email == "")
            {
            ...
            if (_allowSendNotificationMessage && _webMailMode != WebMailMode.View)
            {//If in view mode, do not include notification email information.
        ...
        private void butProvPick_Click(object sender, EventArgs e)
        {
            ...
            {
                _provCur = _listProviders.First(x => x.ProvNum == FormPP.ProvNumSelected);
