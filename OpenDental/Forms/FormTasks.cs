...
namespace OpenDental
{
    ...
    public partial class FormTasks : FormODBase
    {
        ...
        private void FillGridWebChats()
        {
            ...
            {
                listWebChatSessions = WebChatSessions.GetSessions(false, DateTime.Now.AddDays(-7), DateTime.Now.AddYears(1));
            ...
            {//Will only be null if connection to webchat database failed.
                for (int i = 0; i < listWebChatSessions.Count(); i++)
                {
                    ...
                    Color colorBackground = Color.FromArgb(247, 110, 110); //Changing this color will also need to change color in FormWebChatTools.cs
        ...
        private void userControlTasks1_Resize(object sender, EventArgs e)
        {
            ...
            if (_formWindowStateOld == FormWindowState.Minimized)
