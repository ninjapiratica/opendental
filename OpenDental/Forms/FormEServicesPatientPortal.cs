...
namespace OpenDental
{
    ...
    public partial class FormEServicesPatientPortal : FormODBase
    {
        ...
        private void FormEServicesPatientPortal_Load(object sender, EventArgs e)
        {
            ...
            if (textPatientFacingUrlPortal.Text == "")
            { //Customer has not set their own URL so use the URL provided by OD.
        ...
        private void ConstructURL()
        {
            ...
            string url = _signupOutEServiceHQUrls.HostedUrlPayment;
            if (radioPatientPortalLogin.Checked)
            {
                url = _signupOutEServiceHQUrls.HostedUrl;
            }
            if (comboPPClinicUrl.SelectedClinicNum > 0)
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            if (!_webMailNotifBody.Contains("[URL]"))
