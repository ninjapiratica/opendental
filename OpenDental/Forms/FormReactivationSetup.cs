...
namespace OpenDental
{
    ...
    public partial class FormReactivationSetup : FormODBase
    {
        ...
        public void FormReactivationSetup_Load(object sender, System.EventArgs e)
        {
            ...
            if (PrefC.GetLong(PrefName.ReactivationDaysPast) == -1)
            {//For UI display when we store a zero/meaningless value as -1, for this field we want "" to display.
                textDaysPast.Text = "";
            }
            else
            {
            ...
            if (PrefC.GetLong(PrefName.ReactivationContactInterval) == -1)
            {//For UI display when we store a zero/meaningless value as -1, for this field we want "0" to display.
            ...
            if (PrefC.GetLong(PrefName.ReactivationCountContactMax) == -1)
            {//For UI display when we store a zero/meaningless value as -1, for this field we want "" to display.
        ...
        private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (Prefs.UpdateString(prefName, formRecallMessageEdit.MessageVal))
            {
        ...
        private void butOK_Click(object sender, System.EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(textMaxReminders.Text))
            {//""= infinite, 0=disabled; 
