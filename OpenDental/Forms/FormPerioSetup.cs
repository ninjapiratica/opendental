    ...
    public partial class FormPerioSetup : FormODBase
    {
        ...
        private string GetProbingDepthsWithCommas(string probingDepthsAll)
        {
            ...
            for (int i = 0; i < probingDepthsAll.Length; i++)
            {
                ...
                if ((i + 1) % 3 == 0 && i != 47)
                {//Check for every third number to insert comma.
                    retVal += ",";
                }
            }
            return retVal;
        ...
        {
            if (textF1.TextLength == 0 && textF32.TextLength == 0 && textL1.TextLength == 0 && textL32.TextLength == 0)
            { //All textboxes empty.
                return true;
            }
            if (!(textF1.TextLength == 63 && textF32.TextLength == 63 && textL1.TextLength == 63 && textL32.TextLength == 63))
            {//63 for 48 digits + 15 commas.
