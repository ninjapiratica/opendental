...
namespace OpenDental
{
    ...
    public partial class FormOperatories : FormODBase
    {
        ...
        private void butCombine_Click(object sender, EventArgs e)
        {
            ...
            { //We only want to check appt overlap and return if the customer has the relevant pref turned off
                ...
                {//Appointments conflicts exist, can not merge
            ...
            //Point of no return.
            if (!hasNewOp)
            {//Avoids running ReorderAndSync() twice.
