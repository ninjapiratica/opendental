    ...
    public partial class FormDisplayFieldsOrthoChart : FormODBase
    {
        ...
        private void FillGrids()
        {
            ...
            for (int i = 0; i < orthoChartTabFields.ListDisplayFields.Count; i++)
            {
                ...
                if (orthoChartTabFields.ListDisplayFields[i].IsNew)
                {//All new fields have a DisplayFieldNum of 0, so we have to compare by a different value
        ...
        private void butSetupTabs_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < _listOrthoChartTabs.Count; i++)
            {
                ...
                OrthoChartTabFields orthoChartTabFields = new OrthoChartTabFields();
                orthoChartTabFields.OrthoChartTab = _listOrthoChartTabs[i];
                if (orthoChartTabFieldsOld == null)
                {//Either a new tab was added or a hidden tab was un-hidden.
                    orthoChartTabFields.ListDisplayFields = new List<DisplayField>();
                ...
                {//The tab already existed.  Maintain the display field names and order within the tab, especially if the tab order changed.
        ...
        private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            {//Avoid thrown exception in FormDisplayFieldOrthoEdit_Load(...) when adding a new link and then attempting to edit it.
            ...
            if (isAddingNewLink)
            {//Do not add new link to list if user clicks cancel because we want to act like nothing happened
        ...
        private void butRight_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listDisplayFieldsRemoved.Count(); i++)
            {
                ...
                {//An orphaned list doesn't exist yet so create one.
        ...
        private void butDown_Click(object sender, EventArgs e)
        {
            ...
            for (int i = intArrayIndices.Length - 1; i >= 0; i--)
            {//go backwards
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listDisplayFieldsAll.Count; i++)
            {
                if (listDisplayFieldsAll[i].DisplayFieldNum == 0)
                {//New displayfield
            ...
            for (int i = _listOrthoChartTabLinks.Count - 1; i >= 0; i--)
            {
                ...
                {//The tab link no longer exists (was removed).
                    _listOrthoChartTabLinks.RemoveAt(i);
                }
                else
                {//The tab link still exists.  Update the link with any changes.
            ...
            if (orthoChartTabFieldsOrphaned != null)
            {//An orphaned list actually exists.
