...
namespace OpenDental
{
    public partial class FormEmailEdit : FormODBase
    {
        ...
        {
            using FormEmailMasterTemplate formEmailMasterTemplate = new FormEmailMasterTemplate();
        ...
        {
            using FormExternalLink formExternalLink = new FormExternalLink();
            ...
            textContentEmail.SelectedText = "<a href=\"" + formExternalLink.URL + "\">" + formExternalLink.DisplayText + "</a>";
            textContentEmail.SelectionLength = 0;
...
|}";
        ...
        private bool TableOrDoubleClick(int idx)
        {
            ...
            if (formMarkupTableEdit.Markup == null)
            {//indicates delete
        ...
        private void butOk_Click(object sender, EventArgs e)
        {
            ...
            if (!IsRaw)
            {//do not validate for Raw emails. User is responsible for all validation themselves. 
