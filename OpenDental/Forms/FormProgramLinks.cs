...
namespace OpenDental
{
    ...
    public partial class FormProgramLinks : FormODBase
    {
        ...
        private void FillList()
        {
            ...
            gridProgram.Columns.Add(new GridColumn("Program Name", 100) { IsWidthDynamic = true });
        ...
        private void gridProgram_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            {
                case "UAppoint":
                    using (FormUAppoint formUAppoint = new FormUAppoint())
                    {
                        formUAppoint.ProgramCur = program;
                        dialogResult = formUAppoint.ShowDialog();
                    }
                    break;
                case "eClinicalWorks":
                ...
                case "BencoPracticeManagement":
                    using (FormBencoSetup formBencoSetup = new FormBencoSetup())
                    {
                        dialogResult = formBencoSetup.ShowDialog();
                    }
                    break;
                case "CareCredit":
