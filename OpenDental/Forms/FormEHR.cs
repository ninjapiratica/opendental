            ...
            if (e.Col == 3)
            {
                switch (_listEhrMus[e.Row].MeasureType)
                {
                    ...
                    case EhrMeasureType.MedReconcile:
                        ...
                        {//Referral count is less than reconcile count or both are zero.
                            ...
                            if (formReferralSelect.ReferralSelected.IsDoctor)
                        ...
                        {//The referral count is greater than the reconcile count.
