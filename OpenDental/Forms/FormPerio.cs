...
namespace OpenDental
{
    ...
    public partial class FormPerio : FormODBase
    {
        ...
        private bool SkipTooth(int toothNum, bool doVerifyByVoice = true)
        {
            ...
            FillGrid();
            if (_perioCellCurLocation.ToothNum == toothNum)
            {//Go to the next tooth if the _perioCellCurLocation is on the tooth being skipped. 
        ...
        private void CheckMobileActivity()
        {
            ...
            if (_isExamInUse)
            { //Answered No, they would not like to force eClip to checkin, or this method got called by the timer.
        ...
        {
            if (gridODExam.GetSelectedIndex() < 0)
        ...
        {
            if (_perioExam != null)
            { //When no Exam is selected or ExamList is empty we don't want to save ExamNotes.
                PerioExam perioExamOld = _perioExam.Copy();
                _perioExam.Note = textExamNotes.Text;
