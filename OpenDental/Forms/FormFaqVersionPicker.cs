...
namespace OpenDental
{
    public partial class FormFaqVersionPicker : FormODBase
    {
        ...
        public FormFaqVersionPicker(List<int> listVersions, bool isNewFaq)
        {
            InitializeComponent();
            ...
            if (isNewFaq)
            {//Multiple versions can be selected for a new FAQ because multiple FAQs will be made, one for each version selected.
