...
namespace OpenDental
{
    public partial class FormPodiumSetup : FormODBase
    {
        ...
        private void FormPodiumSetup_Load(object sender, EventArgs e)
        {
            ...
            long clinicNum = 0;
            if (Security.CurUser.ClinicIsRestricted)
            {//user is clinic restricted and shouldn't have access to HQ
            ...
            for (int i = 0; i < listProgramPropertiesLocationID.Count; i++)
        ...
        private void SaveClinicCurProgramPropertiesToList()
        {
            ...
            programProperty = _listProgramPropertiesChanged.Find(x => x.ClinicNum == _clinicNum);
            if (programProperty == null)
            {//Get default programproperty from db.
            ...
            if (programPropertyLocationID.ClinicNum == 0)
            {//No program property for current clinic, since _clinicNumCur!=0
                ...
                if (!_listProgramPropertiesChanged.Exists(x => x.ClinicNum == _clinicNum))
