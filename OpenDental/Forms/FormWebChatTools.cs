...
namespace OpenDental
{
    public partial class FormWebChatTools : FormODBase
    {
        ...
        private void FormWebChatTools_Load(object sender, EventArgs e)
        {
            ...
            { //Creates a list of all the supervisors i.e. every employee that has an employee that reports to them
        ...
        private void FillGridWebChats()
        {
            ...
            {//Will only be null if connection to webchat database failed.
                ...
                foreach (WebChatSession webChatSession in listChatSessions)
                {
                    ...
                    if (string.IsNullOrEmpty(webChatSession.TechName) && !checkShowEndedSessions.Checked)
                    {
