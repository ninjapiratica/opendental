...
namespace OpenDental
{
    public partial class FormApptTypeEdit : FormODBase
    {
        ...
        private void FormApptTypeEdit_Load(object sender, EventArgs e)
        {
            ...
            { //logic copied from FormApptEdit
        ...
        private void RefreshListBoxProcCodes()
        {
            ...
            {
                if (_listProcedureCodes[i].CodeNum == 0)
        ...
        private void RefreshListBoxProcCodesRequired()
        {
            ...
            {
                if (_listProcedureCodesRequired[i].CodeNum == 0)
                {//shouldn't happen but just in case
                    continue;
                }
        ...
        private void butClearBlockoutTypes_Click(object sender, EventArgs e)
        {
            listBoxBlockoutTypes.ClearSelected();
        }
