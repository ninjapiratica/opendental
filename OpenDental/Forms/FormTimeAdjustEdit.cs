...
namespace OpenDental
{
    ...
    public partial class FormTimeAdjustEdit : FormODBase
    {
        ...
        private string CreateUnpaidProtectedLeaveSecurityLogText(UnpaidProtectedLeaveLogType logType, TimeAdjust timeAdjust, TimeAdjust timeAdjustEdited = null)
        {
            ...
            string logText;
            if (logType.In(UnpaidProtectedLeaveLogType.Created, UnpaidProtectedLeaveLogType.Deleted))
            {
                ...
                {//logType==UnpaidProtectedLeaveLogType.Deleted
            ...
            {//logType==UnpaidProtectecLeaveLogType.Edited
                ...
                {//!timeAdjust.IsUnpaidProtectedLeave && timeAdjustNew.IsUnpaidProtectedLeave
        ...
        private void butDelete_Click(object sender, EventArgs e)
        {
            ...
            else if (_timeAdjustCur.TimeAdjustNum != 0)
            {//If we are deleting a time card adjustment that is in the DB, log this action.
