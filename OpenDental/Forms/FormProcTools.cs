...
namespace OpenDental
{
    ...
    public partial class FormProcTools : FormODBase
    {
        ...
        private void FormProcTools_Load(object sender, EventArgs e)
        {
            ...
            //USA
            _listProcedureCodes = CDT.Class1.GetADAcodes();
        ...
        private void butRun_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.Now.Between(datePromptStart, datePromptEnd) && checkDcodes.Checked)
            {//Only validate if attempting to update D Codes
            ...
            {//Even though this is first in the interface, we need to run it last, since other regions need the T codes above.
