...
namespace OpenDental
{
    ...
    public partial class FormLabCases : FormODBase
    {
        ...
        private void FillGrid()
        {
            ...
            if (comboClinic.IsAllSelected && !Security.CurUser.ClinicIsRestricted)
            {//"All"
                operatoryNums = null;
            }
            else
            {//"All" that the user has access to or it could be just a single clinic the user has selected
