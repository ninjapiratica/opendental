...
namespace OpenDental
{
    ...
    public partial class FormDepositEdit : FormODBase
    {
        ...
        private void FillClassRefs()
        {
            ...
            if (!isQBAndClassRefsEnabled && !isQBOAndClassRefsEnabled)
            {//Neither QB nor QBO and their respective class refs feature is on, nothing to fill.
                return;
            }
            if (!IsNew)
            {
        ...
        private void ComputeAmt()
        {
            ...
            {//if not new, amount cannot be changed, return
        ...
        private bool CreateDepositQB(bool allowContinue)
        {
            ...
            if (formQBAccountSelect.DialogResult != DialogResult.OK)
            {//Close/Cancel Send QB
                return false;
            }
