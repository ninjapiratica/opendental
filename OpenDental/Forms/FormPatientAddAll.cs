...
namespace OpenDental
{
    public partial class FormPatientAddAll : FormODBase
    {
        ...
        private void FillListPatStatus(ListBoxOD listBox)
        {
            ...
            {//We iterate backwards here so that when the target is removed, we do not run past the loop bounds
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listPatientsAdding.Count; i++)
