...
namespace OpenDental
{
    ...
    public partial class FormRecallTypeEdit : FormODBase
    {
        ...
        private void SetSpecialText()
        {
            ...
            if (comboSpecial.SelectedIndex == 1)
            {//prophy
            ...
            if (comboSpecial.SelectedIndex == 3)
            {//Perio
        ...
        private void FillTriggers()
        {
            ...
            if (_listRecallTriggers.Count == 0 || comboSpecial.SelectedIndex == 2)
            {//child prophy special type has no triggers, triggers from Prophy type are used
                return;
            }
            string str;
        ...
        private void butOK_Click(object sender, System.EventArgs e)
        {
            ...
            {//for child prophy, interval will default to 0, since this special type uses the Prophy default interval
