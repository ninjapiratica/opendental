...
namespace OpenDental
{
    public partial class FormTreatPlanCurEdit : FormODBase
    {
        ...
        private void SelectLabFees(ref GridOD grid)
        {
            ...
            {
                if (listSelectedProcNums.Contains(listAllProcs[i].ProcNum) || listSelectedProcNums.Contains(listAllProcs[i].ProcNumLab))
                {
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            TreatPlans.SyncTreatPlanStatusWithProcs(TreatPlanCur, _makeActive, _listTpAttachesCur, _listTpAttachesAll, _listTpProcsCur);
