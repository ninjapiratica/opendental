...
namespace OpenDental
{
    public partial class FormMassEmailBirthdays : FormODBase
    {
        ...
        private void FormMassEmailBirthdays_Load(object sender, EventArgs e)
        {
            ...
            if (_listApptReminderRules.FindAll(x => x.ClinicNum == 0).Count == 1)
            {//default to default clinic on load. 
        ...
        private void comboClinic_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            if (!_isLoading)
            {
                ...
                {//if there were problems, do not change clinics.
        ...
        private string ValidateCurrentSelection()
        {
            ...
            for (int i = 0; i < listApptReminderRules.Count; i++)
            {
                ...
                {//this may be validated already in the template edit window.
