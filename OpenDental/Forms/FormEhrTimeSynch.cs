...
namespace OpenDental
{
    ...
    public partial class FormEhrTimeSynch : FormODBase
    {
        ...
        private void refreshDisplays()
        {
            ...
            if (!LocalInSynch())
            { //This should not happen, time is updated automatically. If you get to this point, you should have already had a message box pop up saying there was an error updating your local time.
