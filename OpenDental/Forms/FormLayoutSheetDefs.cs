...
namespace OpenDental
{
    ...
    public partial class FormLayoutSheetDefs : FormODBase
    {
        ...
        private List<SheetDef> _listSheetDefsOther;
        ///<summary>List of sheetDefs to show in gridCustomLayouts.</summary>
        private List<SheetDef> _listSheetDefsCustom;
        ...
        private void RefreshAndFillGrids(long selectedSheetNum = -1)
        {
			...
			_listSheetDefsOther=new List<SheetDef>() { SheetsInternal.GetSheetDef(SheetInternalType.ChartModule) };//Must always be first in list.
			List<SheetDef> listSheetDefsCustom=SheetDefs.GetCustomForType(SheetTypeEnum.ChartModule);
			...
			#endregion
			FillGrid(gridOtherLayouts,_listSheetDefsOther,selectedSheetNum);
			FillGrid(gridCustomLayouts,_listSheetDefsCustom,selectedSheetNum);*/
        }
        ...
        {
            //SheetDef sheetDef=_listSheetDefsOther[e.Row];
        ...
        {
            //SheetDef sheetDef=_listSheetDefsCustom[e.Row];
        ...
        private void butCopy_Click(object sender, EventArgs e)
        {
            ...
            //	return;
            //}
            //SheetDef sheetDef=_listSheetDefsOther[gridOtherLayouts.SelectedIndices[0]].Copy();
            //if(sheetDef.SheetDefNum!=0) {//Is not the internal sheet.
            //	SheetDefs.GetFieldsAndParameters(sheetDef);//Other user custom sheetdefs need their fields filled.
            //}
        ...
        {
            //This button is not enabled unless user has appropriate permission for setup.
            //SheetDef sheetDefNew=_listSheetDefsOther[0].Copy();//First item is always internal.  Only 1 interal sheet def per instance of this window.
            //sheetDefNew.Description="Custom Layout "+(_listSheetDefsCustom.Count+1).ToString();
        ...
        private void butDuplicate_Click(object sender, EventArgs e)
        {
            ...
            //	return;
            //}
            //SheetDef sheetDef=_listSheetDefsCustom[gridCustomLayouts.SelectedIndices[0]].Copy();
            ////sheetDef.UserNum=Security.CurUser.UserNum;
