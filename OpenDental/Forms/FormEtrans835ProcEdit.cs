...
namespace OpenDental
{
    public partial class FormEtrans835ProcEdit : FormODBase
    {
        ...
        private void pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            #region printHeading
            if (_eraProcPrintingProgress == EraProcPrintingProgress.DocumentHeader)
            {//Only print the document heading on the first page.
                string text;
            ...
            if (_eraProcPrintingProgress == EraProcPrintingProgress.GridProcAdjHeader)
            ...
            #endregion
            #region GridRemarks
            if (_eraProcPrintingProgress == EraProcPrintingProgress.GridRemarksHeader)
            {//Only draw header once
            ...
            if (_eraProcPrintingProgress == EraProcPrintingProgress.GridSupplementalHeader)
            {//Only draw header once
        ...
        private void PrintGridHelper(GridOD grid, Rectangle rectangle, Graphics g, PrintPageEventArgs e)
        {
            ...
            if (y == -1)
            {//Additional page needed to print the rest of the grid.
