...
namespace OpenDental
{
    public partial class FormGradingScaleEdit : FormODBase
    {
        ...
        private void gridMain_DoubleClick(object sender, EventArgs e)
        {
            ...
            using FormGradingScaleItemEdit formGradingScaleItemEdit = new FormGradingScaleItemEdit(_listGradingScaleItems[gridMain.GetSelectedIndex()]);
            formGradingScaleItemEdit.ShowDialog();
            FillGrid();
        }
        ...
        private void butAdd_Click(object sender, EventArgs e)
        {
            ...
            using FormGradingScaleItemEdit formGradingScaleItemEdit = new FormGradingScaleItemEdit(gradingScaleItem);
            formGradingScaleItemEdit.ShowDialog();
            FillGrid();
        }
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            if (GradingScales.IsDupicateDescription(_gradingScale))
            {//This will check it for like types.
            ...
            _gradingScale.Description = textDescription.Text;
            _gradingScale.ScaleType = (EnumScaleType)comboScaleType.SelectedIndex;
            if (comboScaleType.SelectedIndex != (int)EnumScaleType.PickList && comboScaleType.Visible)
            {//Deletes all items if not picklist scaletype.
