...
namespace OpenDental
{
    ...
    public partial class FormProcButtons : FormODBase
    {
        ...
        private void SetVisibility()
        {
            ...
            {//make all controls visible. Then hide below.
        ...
        private void FillCategories()
        {
            ...
            {//category was hidden, or just opening the form
                listCategories.SelectedIndex = 0;
                _catSelected = 0;
            }
            if (listCategories.SelectedIndex > 0)
            {//hardcoded category doesn't have a DefNum.
        ...
        private void panelQuickButtons_RowDoubleClick(object sender, ODButtonPanelEventArgs e)
        {
            ...
            if (formProcButtonQuickEdit.ProcButtonQuickCur == null)
            {//clicked on either a blank row or to the right of existing buttons on a row.
                ...
                { //Set ItemOrder
                    if (_listProcButtonQuicks[i].YPos != formProcButtonQuickEdit.ProcButtonQuickCur.YPos //Wrong row
                        || formProcButtonQuickEdit.ProcButtonQuickCur.ItemOrder > _listProcButtonQuicks[i].ItemOrder)
                    { //Already have a larger item order
                        continue;
                    }
