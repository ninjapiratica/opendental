...
namespace OpenDental
{
    ...
    public partial class FormDatabaseMaintenance : FormODBase
    {
        ...
        private void FillGridHidden()
        {
            ...
            gridHidden.Columns.Add(new GridColumn(Lan.g(this, "Name"), 340));
        ...
        {
            if (grid.ListGridRows.Count > 0 && grid.Columns.Count < 3)
            {//Enforce the requirement of having the Results column as the third column.
            ...
            stringBuilderLogText.Append(tupleTableCheckResult.Item1);
            ...
            _threadRunDBM = new ODThread(new ODThread.WorkerDelegate((ODThread o) =>
            {
                for (int i = 0; i < intArraySelectedIndices.Length; i++)
                {
                    ...
                    {//Only possible if running a check / fix in non-verbose mode and nothing happened or needs to happen.
        ...
        private void pd2_PrintPage(object sender, PrintPageEventArgs printPageEventArgs)
