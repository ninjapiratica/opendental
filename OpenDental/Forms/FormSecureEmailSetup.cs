...
namespace OpenDental
{
    public partial class FormSecureEmailSetup : FormODBase
    {
        ...
        public FormSecureEmailSetup(WebServiceMainHQProxy.EServiceSetup.SignupOut signupOut = null)
        {
            InitializeComponent();
        ...
        private void FillClinicsGrid()
        {
            ...
            col.Tag = new OnGridCellClick((clinicNum) => ToggleEnabled(clinicNum, PrefName.EmailSecureStatus));
            gridClinics.Columns.Add(col);
