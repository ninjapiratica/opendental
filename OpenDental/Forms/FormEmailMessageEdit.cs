    ...
    public partial class FormEmailMessageEdit : FormODBase
    {
        ...
        private void butInsertTemplate_Click(object sender, System.EventArgs e)
        {
            ...
            if (EmailMessages.IsHtmlEmail(emailTemplateSelected.TemplateType))
            {
                ...
                if (!HasValidInlineAttachments(emailTemplateSelected.BodyText, isRawHtml))
                { //Need to check inline images if they are valid
                    return;
                }
        ...
        private void SetDefaultAutograph()
        {
            ...
            if (!IsAutographHTML(emailAutograph))
            {//HTML autographs will be appended automatically on send.
        ...
        private void butAddAutograph_Click(object sender, EventArgs e)
        { //add a new autograph
        ...
        private void butDirectMessage_Click(object sender, EventArgs e)
        {
            ...
            Cursor = Cursors.WaitCursor;
            if (EmailMessages.GetReceiverUntrustedCount(emailPreview.ToAddress) >= 0)
            {//Not trusted yet.
