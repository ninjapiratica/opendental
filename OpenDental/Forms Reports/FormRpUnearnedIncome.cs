...
namespace OpenDental
{
    public partial class FormRpUnearnedIncome : FormODBase
    {
        ...
        private void FillClinics()
        {
            ...
            {//hide label,list,and check box if clinics are not enabled
        ...
        private void butUnearnedAllocationOK_Click(object sender, EventArgs e)
        {
            ...
            if (checkUnearnedAllocationAllClins.Checked)
            {//All Clinics selected; add all visible or hidden unrestricted clinics to the list
            ...
            if (PrefC.HasClinicsEnabled)
            {//show sub titles if clinics are enabled. 
                if (checkUnearnedAllocationAllClins.Checked)
                {
        ...
        private void tabControlMain_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {//Unearned Allocation
                try
                {
                    ...
                    if (versionMySQL <= new Version("5.5.62"))
                    {//highest version possible of MySQL 5.5
