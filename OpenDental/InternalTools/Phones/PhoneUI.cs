    ...
    public class PhoneUI
    {
        ...
        public static void Add(Phone PhoneCur)
        {
            ...
            else
            {
                ...
                ph.PatNum = FormOpenDental.PatNumCur;
        ...
        public static void Available(Phone phone, bool isAtHome = false)
        {
            ...
            if (Security.CurUser.EmployeeNum != phone.EmployeeNum)
            { //We are on someone else's tile. So Let's do some checks before we assume we can take over this extension.
                ...
                if (ClockEvents.IsClockedIn(phone.EmployeeNum))
        ...
        {
            if (!ClockEvents.IsClockedIn(Security.CurUser.EmployeeNum))
        ...
        public static void BuildMenuStatus(ContextMenuStrip menuStatus, Phone phoneCur)
        {
            ...
            if (phoneCur.EmployeeNum == Security.CurUser.EmployeeNum)
        ...
        private static bool ChangeTileStatus(Phone phoneCur, ClockStatusEnum newClockStatus)
        {
            ...
            if (!ClockEvents.IsClockedIn(phoneCur.EmployeeNum))
            { //Employee having action performed must be clocked in.
        ...
        {
            if (Security.CurUser.EmployeeNum == phoneCur.EmployeeNum)
