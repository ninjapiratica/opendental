    ...
    public partial class MapPanel : UserControl
    {
        ...
        private void MapPanel_MouseDown_Normal(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                CubicleClicked?.Invoke(this, cubicleClickedDetail);
                if (HitTestName(idx, e.Location))
                {//left clicked on name
                ...
                if (HitTestPhone(idx, e.Location) && ListMapAreaMores[idx].PatNumCall != 0)
                {//left clicked on phone icon
            ...
            if (ListMapAreaMores[idx].EmployeeNum == Security.CurUser.EmployeeNum)
            ...
            if (ListMapAreaMores[idx].PatNumCall == 0)
            {//disable goto if not a current patient
        ...
        private void DrawCubicleSmall(Graphics g, int i)
        {
            ...
            if (ListMapAreaMores[i].TimeSpanElapsed.Hours > 0)
            { //no room for hours and seconds
