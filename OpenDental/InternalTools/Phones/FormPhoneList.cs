...
namespace OpenDental
{
    public partial class FormPhoneList : FormODBase
    {
        ...
        private void listBoxStatus_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            if (phone.EmployeeNum == Security.CurUser.EmployeeNum)
        ...
        private void FillGrid()
        {
            ...
            for (int i = 0; i < _listPhonesShowing.Count; i++)
            {
                ...
                else if (_listPhonesShowing[i].Description != "")
                {//InUse
                ...
                if (isWorkingHome)
                {//draw the home icon regardless of whether they are clocked in or out
