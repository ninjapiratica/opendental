...
namespace OpenDental.InternalTools.Phones
{
    public partial class EscalationView : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            {
                if (i > idxStartFade)
                { //Only start fading after the user defined fade index.
        ...
        protected override void OnMouseWheel(MouseEventArgs e)
        {
            ...
            {//MouseWheel down
                ...
                if (ListEscalationItems.Count - _indexItemStart < 1)
                {//Difference represents the number of items we are goin to draw.
