...
namespace OpenDental
{
    public partial class PhoneTile : UserControl
    {
            ...
            WebChatSession webChatSession, PeerInfo remoteSupportSession, bool doHideIfNoPhone = false)
        {
            ...
            if (LayoutHorizontal)
            {//never used anymore.  Was used to draw large phone map.
            ...
            { //vertical (the one at the lower left of each person's screen)
            ...
            else if (chatUserCur != null && chatUserCur.CurrentSessions != 0)
            {//active GTA session
        ...
        private void ResetTimer(bool isWebChatEnding)
        {
            ...
            {//J.M. Currently CanWebChatResetTimer is never false, leaving for now.
                return;
            }
