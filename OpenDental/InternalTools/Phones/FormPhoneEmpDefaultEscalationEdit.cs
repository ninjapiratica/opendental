...
namespace OpenDental
{
    public partial class FormPhoneEmpDefaultEscalationEdit : FormODBase
    {
        ...
        private void FillTabs()
        {
            ...
            foreach (System.Windows.Forms.TabPage tab in tabMain.TabPages)
            {//Equivalent to tabMain.TabPages.Clear()
                LayoutManager.Remove(tab);
                tab.Dispose();
            }
            tabPage = new System.Windows.Forms.TabPage(PhoneEmpSubGroupType.Avail.ToString());
            ...
            foreach (PhoneEmpSubGroupType e in Enum.GetValues(typeof(PhoneEmpSubGroupType)))
            {
                ...
                tabPage = new System.Windows.Forms.TabPage(e.ToString());
        ...
        {
            if (!tabMain.TabPages.ContainsKey(PhoneEmpSubGroupType.Escal.ToString()))
