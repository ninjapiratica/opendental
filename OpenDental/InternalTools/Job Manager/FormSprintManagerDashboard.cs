...
namespace OpenDental
{
    public partial class FormSprintManagerDashboard : FormODBase
    {
        ...
        private void RefreshAll()
        {
            ...
            List<Job> listRemainingBugJobs = listBugJobs.FindAll(x => x.PhaseCur.In(
            ...
            double totalJobsRemaining = _listAttachedJobs.Where(x => x.PhaseCur.In(
        ...
        private void FillGridOldBugs(List<Job> listStaleBugJobs)
        {
            ...
            gridBugJobs.Columns.Add(new GridColumn("Last Updated", 200, HorizontalAlignment.Center));
            gridBugJobs.Columns.Add(new GridColumn("", 100) { IsWidthDynamic = true });
        ...
        private void FillGridQueue()
        {
            ...
            gridSprintQueue.Columns.Add(new GridColumn("Priority", 90, HorizontalAlignment.Center));
            gridSprintQueue.Columns.Add(new GridColumn("Owner", 55, HorizontalAlignment.Center));
            gridSprintQueue.Columns.Add(new GridColumn("Owner Action", 110));
            gridSprintQueue.Columns.Add(new GridColumn("EstHrs", 60, HorizontalAlignment.Center, GridSortingStrategy.AmountParse));
            gridSprintQueue.Columns.Add(new GridColumn("ActHrs", 60, HorizontalAlignment.Center, GridSortingStrategy.AmountParse));
            gridSprintQueue.Columns.Add(new GridColumn("", 300));
        ...
        private void FillGridActiveDevelopment()
        {
            ...
            gridActiveDevelopment.Columns.Add(new GridColumn("Priority", 90, HorizontalAlignment.Center));
            gridActiveDevelopment.Columns.Add(new GridColumn("Last Updated", 90, HorizontalAlignment.Center));
            gridActiveDevelopment.Columns.Add(new GridColumn("Owner", 55, HorizontalAlignment.Center));
            gridActiveDevelopment.Columns.Add(new GridColumn("Owner Action", 110));
            gridActiveDevelopment.Columns.Add(new GridColumn("EstHrs", 60, HorizontalAlignment.Center, GridSortingStrategy.AmountParse));
            gridActiveDevelopment.Columns.Add(new GridColumn("ActHrs", 60, HorizontalAlignment.Center, GridSortingStrategy.AmountParse));
            gridActiveDevelopment.Columns.Add(new GridColumn("", 300));
