...
namespace OpenDental
{
    public partial class FormBugSearch : FormODBase
    {
        ...
        private void FillGridMain()
        {
            ...
            {
                gridMain.Columns.Add(new GridColumn("BugId", 50));
                gridMain.Columns.Add(new GridColumn("Date", 65) { SortingStrategy = GridSortingStrategy.DateParse });
                gridMain.Columns.Add(new GridColumn("Status", 60) { TextAlign = HorizontalAlignment.Center });
                gridMain.Columns.Add(new GridColumn("OD Found", 75));
                gridMain.Columns.Add(new GridColumn("OD Fixed", 75));
                gridMain.Columns.Add(new GridColumn("Platform", 75));
                gridMain.Columns.Add(new GridColumn("Description", 50));
            }
            else
            {
                gridMain.Columns.Add(new GridColumn("BugId", 50));
                gridMain.Columns.Add(new GridColumn("Date", 75) { SortingStrategy = GridSortingStrategy.DateParse });
                gridMain.Columns.Add(new GridColumn("Status", 75) { TextAlign = HorizontalAlignment.Center });
                gridMain.Columns.Add(new GridColumn("Pri", 50) { TextAlign = HorizontalAlignment.Center });
                gridMain.Columns.Add(new GridColumn("Vers. Found", 75));
                gridMain.Columns.Add(new GridColumn("Vers. Fixed", 75));
                gridMain.Columns.Add(new GridColumn("Description", 50));
            }
        ...
        private void butViewSubs_Click(object sender, EventArgs e)
        {
            ...
            if (FormBugSubs.ShowDialog() == DialogResult.OK && FormBugSubs.BugCur != null)
            {//Bug was created.
                MobileBugCur = null;
