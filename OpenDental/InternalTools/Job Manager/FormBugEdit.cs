...
namespace OpenDental
{
    public partial class FormBugEdit : Form
    {
        ...
        private void FillGrid()
        {
            ...
            {
                gridSubs.Columns.Add(new GridColumn("Reg Key", 125));
                gridSubs.Columns.Add(new GridColumn("Version", 60, GridSortingStrategy.VersionNumber));
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            else if (comboStatus.SelectedIndex == 0)
            {//none
