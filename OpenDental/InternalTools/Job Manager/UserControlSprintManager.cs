...
namespace OpenDental
{
    public partial class UserControlSprintManager : UserControl
    {
        ...
        private void FillGridJobs()
        {
            ...
            gridSprintJobs.Columns.Add(new GridColumn("Priority", 90, HorizontalAlignment.Center));
            gridSprintJobs.Columns.Add(new GridColumn("Owner", 55, HorizontalAlignment.Center));
            gridSprintJobs.Columns.Add(new GridColumn("Owner Action", 110));
            gridSprintJobs.Columns.Add(new GridColumn("EstHrs", 60, HorizontalAlignment.Center, GridSortingStrategy.AmountParse));
            gridSprintJobs.Columns.Add(new GridColumn("ActHrs", 60, HorizontalAlignment.Center, GridSortingStrategy.AmountParse));
            gridSprintJobs.Columns.Add(new GridColumn("", 300));
