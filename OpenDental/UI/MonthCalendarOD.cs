...
namespace OpenDental.UI
{
    ...
    public partial class MonthCalendarOD : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            _rectangleTopText = new Rectangle(x: (Width / 2 - (int)strMonthSize.Width / 2) - LayoutManager.Scale(10),
                y: (LayoutManager.Scale(33) / 2 - (int)strMonthSize.Height / 2) - LayoutManager.Scale(5),
                width: (int)strMonthSize.Width + LayoutManager.Scale(20),
                height: (int)strMonthSize.Height + LayoutManager.Scale(10));
