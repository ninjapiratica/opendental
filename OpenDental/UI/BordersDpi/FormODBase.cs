...
namespace OpenDental
{
    ...
    public class FormODBase : Form
    {
        ...
        protected Point _pointMousePrevious;
    ...
    public new FormStartPosition StartPosition{ get; set;	}*/
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            if (LayoutManager != null && Controls.Contains(PanelClient))
            {
                ...
                {//When minimized, loc seems to be -32000,-32000
                    return;
                }
        ...
        private void PanelBorders_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                xPos -= wEdge;
                _rectangleButHelp = new Rectangle(xPos, yPos - 2, LayoutManager.HeightTitleBar() - 4, LayoutManager.HeightTitleBar() - 4);
            }
            ...
            int indentTop = LayoutManager.Scale(5);//7
            int indentLeft = LayoutManager.Scale(10);
            //indentTop+LayoutManager.Scale(3);
            //Button X:
            if (_isHotX)
            {
        ...
        private void PanelBorders_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {//mouse is down
                ...
                if (_pointMousePrevious == Control.MousePosition)
                {//no actual mouse movement
                    return;
                }
            }
            #region Cursors
            int widthBorder = LayoutManager.WidthBorder();//5, scaled
            if (e.X < MaxInset() + widthBorder + 2 && e.Y < MaxInset() + widthBorder + 2)
            {//UL corner
        ...
        private void PanelBorders_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (_rectangleButMin.Contains(e.Location) && MinimizeBox)
            {
                ...
                if (WindowState != FormWindowState.Maximized)
                {//not an issue if starting maximized
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            {//client area calculation. We always fill the entire window.
                ...
                {//wParam false. Application does not need to indicate the valid part of the client area.
                    base.WndProc(ref m);
                    return;
        ...
        public static void SignalsTick(Action<bool> onShutdown, Action<List<FormODBase>, List<Signalod>> onProcess, Action onDone, bool isAllInvalidTypes = true)
        {
            ...
            ODThread threadRefreshSignals = new ODThread((o) =>
            {
                ...
                if (RemotingClient.MiddleTierRole == MiddleTierRole.ClientMT
                    && !listSignals.Any(x => x.RemoteRole == MiddleTierRole.ClientDirect))
                {
