...
namespace OpenDental
{
    ...
    public partial class ClassConvertDatabase
    {
        ...
        public bool Convert(string fromVersion, string toVersion, bool isSilent, Form currentForm, bool useDynamicMode)
        {
            ...
            {//Allow databases with no reg key to update.  Needed by our conversion department.
            ...
            if (!isSilent && FromVersion > new Version("16.3.0") && FromVersion < new Version("16.3.29") && ApptReminderRules.UsesApptReminders())
            {
                ...
                if (listReminderFlags?[0] ?? false)
                { //2 reminders scheduled for same day of appointment. 1 will be converted to future day reminder.
                ...
                if (listReminderFlags?[1] ?? false)
                { //2 reminders scheduled for future day of appointment. 1 will be converted to same day reminder.
