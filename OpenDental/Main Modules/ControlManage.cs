...
namespace OpenDental
{
    ...
    public class ControlManage : UserControl
    {
        ...
        private void butSendClaims_Click(object sender, EventArgs e)
        {
            ...
            if (_formClaimsSend != null && !_formClaimsSend.IsDisposed)
            {//Form is open
        ...
        private void ShowBilling(long clinicNum, bool isHistStartMinDate = false, bool showBillTransSinceZero = false)
        {
            ...
            if (_formBilling != null && !_formBilling.IsDisposed)
            {
                ...
                {
                    if (_formBilling.ListClinics[i].ClinicNum != clinicNum)
        ...
        private bool ValidateConnectionDetails()
        {
            ...
            foreach (long clinicNum in listClinicNums)
            {
                ...
                if (listProgramProperties.All(x => x.ClinicNum != clinicNum))
