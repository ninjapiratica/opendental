...
namespace OpenDental
{
    ...
    public partial class ControlImagesJ : UserControl
    {
        ...
        public void LayoutToolBars()
        {
            ...
            ToolStripMenuItem toolStripMenuItem3 = new ToolStripMenuItem(Lan.g(this, "Export TIFF"));
            toolStripMenuItem3.Click += ToolBarExportTIFF;
            contextMenuStripExport.Items.Add(toolStripMenuItem3);
        ...
        public void ModuleSelected(long patNum, long docNum = 0)
        {
            ...
            if (_patCur != null && _patCur.PatStatus == PatientStatus.Deleted)
            {
                ...
                {//Exception should never get thrown because RefreshModuleData() will return when PatNum is zero.
                    FriendlyException.Show(Lan.g(this, "Error accessing images."), ex);
                }
            }
            RefreshModuleScreen();
        ...
        {
            for (int i = _listFormImageFloats.Count - 1; i >= 0; i--)
            {//go backwards
        ...
        public void SelectTreeNode(NodeTypeAndKey nodeTypeAndKey, string localPathImportedCloud = "")
        {
            ...
            if (formImageFloat != null && !formImageFloat.IsDisposed)
            {//found the doc/mount we're after already showing in a floater.
        ...
        private void imageSelector_DraggedToCategory(object sender, DragEventArgsOD e)
        {
            if (e.DocNum != 0)
            {
                ...
                if (document == null || document.DocNum != e.DocNum)
                {
                    ...
                    if (document == null)
                    {//The document being moved was deleted by another instance of the program
        ...
        public void LayoutControls()
        {
            ...
            else
            {
                ...
                if (LayoutManager.Scale(_widthTree96) > Width - LayoutManager.Scale(150))
                {//this is the min set in FormODBase for FormImageFloat
        ...
        private void ToolBarMountAcquire_Click()
        {
            ...
            while (true)
            {
                ...
                {
                    if (e.Message != "")
                    {//If user cancels, there is no text.  We could test e.DeviceStatus instead
        ...
        private bool PlaceAcquiredBitmapInUI(Bitmap bitmap)
        {
                ...
                || GetIdxSelectedInMount() == -1)
            {
                ...
                if (listMountItemsAvail2 is null)
                {//no more available slots, so start saving in unmounted area
                    SetIdxSelectedInMount(-1);
                }
                else
        ...
        private void ToolBarMoveToPatient(object sender, EventArgs e)
        {
            ...
            FormImageFloat formImageFloat = GetFormImageFloatSelected();
            GotoModule.GotoImage(formPatientSelect.PatNumSelected, 0);
        ...
        private void ToolbarScanWeb(string scanType)
        {
            ...
            {//The scan was probably cancelled.
                return;
            }
            ImageType imgType;
            if (scanType == "xray")
