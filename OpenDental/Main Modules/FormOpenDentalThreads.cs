...
namespace OpenDental
{
    ...
    public partial class FormOpenDental : FormODBase
    {
        ...
        private void ProcessHqMetricsPhones()
        {
            ...
            {//An empty string value within triageMetrics.WebChatSessions will deserialize to null.
                listWebChatSessions = new List<WebChatSession>();
            }
            if (listRemoteSupportSessions == null)
            {//An empty string value within triageMetrics.RemoteSupportSessions will deserialize to null.
        ...
        private void ProcessHqMetricsEServices()
        {
            ...
            if (_listFormMapHQs.Count == 0 && _listFormMaps.Count == 0)
            { //Do not run if the HQ map is not open.
                return;
            }
