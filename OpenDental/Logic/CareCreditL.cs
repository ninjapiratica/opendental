...
namespace OpenDental
{
    public class CareCreditL
    {
        ...
        public static string GetQSPageUrl(Patient pat, long provNum, long clinicNum, double estimatedFeeAmt, string invoiceNum = null, string practiceMemo = null, string userName = null)
        {
            CareCreditWebResponse ccWebResponseBatchOriginal = CareCreditWebResponses.GetOriginalCompletedBatchForPatNum(pat);
            string refId = ccWebResponseBatchOriginal?.RefNumber ?? null;
            return TryLaunchCareCreditPage(CareCreditLandingPage.QS, pat, provNum, clinicNum, CareCredit.IsMerchantNumberByProv, estimatedFeeAmt: estimatedFeeAmt,
        ...
        {
            if (string.IsNullOrEmpty(merchantNum))
            {//No merchant number passed in
                try
                {
            ...
            catch (CareCredit.CareCreditException cce)
            {
