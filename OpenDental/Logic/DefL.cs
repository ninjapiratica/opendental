...
namespace OpenDental
{
    public class DefL
    {
            ...
            foreach (DefCat defCatCur in defCatVals)
            {
                ...
                switch (defCatCur)
                {
                    ...
                    case DefCat.ApptProcsQuickAdd:
                        ...
                        {
                            defCOption.HelpText = Lans.g("FormDefinitions", "These are the procedures that you can quickly add to the treatment plan from within the appointment editing window. Multiple procedures may be separated by commas with no spaces. They generally will not require a tooth number, but a single tooth number is allowed. Example: D1111#8. These definitions may be freely edited without affecting any patient records.");
                        }
                        break;
                    ...
                    case DefCat.OperatoryTypes:
                        ...
                        defCOption.CanHide = true;
                        defCOption.CanEditName = true;
                        defCOption.HelpText = Lans.g("FormDefinitions", "Types for the Operatory. This value is not normally used.");
                        break;
                    ...
                    case DefCat.TaskCategories:
                        ...
                        defCOption.DoShowNoColor = true;
                        defCOption.EnableColor = true;
                        defCOption.HelpText = Lans.g("FormDefinitions", "The categories for tasks. HQ Only as of now.");
                        break;
        ...
        private static string GetItemDescForImages(string itemValue)
        {
            ...
            {
                listVals.Add(Lan.g(_lanThis, "Thumbnails"));
            }
            ...
            {
                listVals.Add(Lan.g(_lanThis, "TaskAttachments"));
            }
