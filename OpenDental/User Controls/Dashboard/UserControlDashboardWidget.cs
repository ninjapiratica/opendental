...
namespace OpenDental
{
    public partial class UserControlDashboardWidget : UserControl
    {
        ...
        {
            if (_sheetDef == null || data == null)
            {//Hasn't been through initialize, or unexpected data.
                return false;
            }
            if (data.StaticTextData != null)
            {//Only change static text fields if the required data is available.
