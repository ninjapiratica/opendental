...
namespace OpenDentalGraph
{
    public partial class GraphQuantityOverTime : UserControl, IODGraphPrinter
    {
        ...
        private void FilterData(object sender, EventArgs e)
        {
            ...
            if (BreakdownPref == Enumerations.BreakdownType.items)
            { //Order descending and take top x items.
                topGrossingCount = (int)numericTop.Value;
            }
            else if (BreakdownPref == Enumerations.BreakdownType.percent)
            ...
            else if (BreakdownPref == Enumerations.BreakdownType.none)
