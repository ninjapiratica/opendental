    ...
    public partial class DashboardTabCtrl : UserControl
    {
        ...
        public bool IsEditMode
        {
            ...
            set
            {
                ...
                if (IsEditMode)
                { //Insert 'add' tab if it's not already there.
                ...
                { //Remove 'add' tab if it's not already there.
        ...
        public bool HasUnsavedChanges
        {
            get
            {
                ...
                { //Tab pages have been added or removed.
                    return true;
                }
        ...
        {
            TabPage tabPage; DashboardPanelCtrl dashboardPanel;
            if (IsEditMode && !GetDashboardPanel(e.TabPageIndex, out tabPage, out dashboardPanel))
            { //Prevent 'add' tab from being selected.
                e.Cancel = true;
            }
        }
        #endregion
