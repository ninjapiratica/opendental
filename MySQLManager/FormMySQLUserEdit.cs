...
namespace MySQLManager
{
    public partial class FormMySQLUserEdit : Form
    {
        ...
        private void SetPermissions()
        {
            ...
            {//This user has neither the 'Full' nor 'Low' permission set.
        ...
        {
            if (textUser.Text == "" && (_isNew || _userName != ""))
            {//If the existing username is '', we will allow it.
            ...
            try
            {
                ...
                if (textUser.Text != _userName)
                {//It doesn't really work to update a username, so we'll drop and recreate.
