...
namespace xCrudGenerator
{
    ...
    {//do not inherit from TableBase because it's not a real table
        ...
        ///<summary>The crud will create this as a varchar(255) and the programmer must change it manually. -Jordan I think this may now be wrong.  I think it probably generates the type as text.</summary>
