...
namespace ServiceManager
{
    public partial class FormWebConfigSettings : Form
    {
        ...
        private void FormWebConfigSettings_Load(object sender, EventArgs e)
        {
            ...
            try
            {//Try FreeDentalConfig.xml first
            ...
            {//FreeDentalConfig didn't load correctly
                ex.DoNothing();
        ...
        public bool TestConnection(bool isOneWayRepMaster = false)
        {
            ...
            try
            {
                ...
                string userLow;
                string passwordLow;
                if (isOneWayRepMaster)
                {//The replication service uses a direct connection. The low user is never used.
                    userLow = "";
                    passwordLow = "";
                }
                else
