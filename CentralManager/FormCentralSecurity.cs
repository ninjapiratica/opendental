...
namespace CentralManager
{
    public partial class FormCentralSecurity : Form
    {
        ...
        private void userControlSecurityTabs_AddUserClick(object sender, SecurityEventArgs e)
        {
            ...
            FormCU.ShowDialog();
            if (FormCU.DialogResult == DialogResult.OK)
        ...
        private DialogResult userControlSecurityTabs_AdjustmentTypeDenyPermissionChecked(object sender, SecurityEventArgs e)
        {
            ...
            if (listGroupPermissionsOld.IsNullOrEmpty())
            {//Does not have any permissions, give them the all permission. Otherwise, grant them no permission.
