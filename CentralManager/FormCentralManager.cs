...
namespace CentralManager
{
    public partial class FormCentralManager : Form
    {
        ...
        private void butSearchPats_Click(object sender, EventArgs e)
        {
            ...
            if (butSearchPats.Text != Lans.g(this, "Search"))
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            for (int i = _listWindowInfos.Count - 1; i >= 0; i--)
            {//loop backward so we can remove bad ones
             //we try to fix zero here
                ...
                try
                {
                    ...
                    if (showState == ShowState.SW_HIDE)
                    {//window is gone
        ...
        private void FillGridConns(List<long> listConnNums = null)
        {
            ...
            for (int i = 0; i < listConnsFiltered.Count; i++)
            {
                ...
                if (listConnsFiltered[i].DatabaseName == "")
                {//uri
        ...
        private bool GetConfigAndConnect()
        {
            ...
            try
            {
                ...
                { //Using middle tier connection
                    _middleTierAddr = nodeMT.Value;
                    _usingMiddleTier = true;
                    if (nav.SelectSingleNode("UsingAutoLogin") != null)
                    {  //Using "Log me in automatically" via Middle Tier
        ...
        public static ShowState GetWindowState(IntPtr hwnd)
        {//, out System.Drawing.Rectangle rect) {This rect is useless to us.  It's some sort of "restore" rect.
        ...
        private void LaunchConnection(CentralConnection conn, long patNum = 0)
        {
            ...
            if (windowInfo == null)
            {//new, so double clicked on a connection with no previous window.
