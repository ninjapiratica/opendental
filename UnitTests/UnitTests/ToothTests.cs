...
namespace UnitTests.Tooth_Tests
{
    ...
    public class ToothTests : TestBase
    {
        ...
        public void FormatRangesForDisplay()
        {
            ...
            string result = Tooth.DisplayRange(inputrange);
            ...
            result = Tooth.DisplayRange(inputrange);
