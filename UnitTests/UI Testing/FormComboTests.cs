...
namespace UnitTests
{
    public partial class FormComboTests : FormODBase
    {
        ...
        List<MiddleTierRole> _listRemotingRole = new List<MiddleTierRole>();
        ...
        private void FormComboTests_Load(object sender, EventArgs e)
        {
            ...
            stringArray[0] = "A";
            stringArray[1] = "B";
            comboBoxMS.Items.AddRange(stringArray);
            cPlus.Items.AddList(stringArray);
            for (int i = 0; i < 15; i++)
            {
                ...
                if (i % 2 == 0)
                {
                    ...
                    cPlus2.Items.Add("Different and much longer" + i.ToString());
