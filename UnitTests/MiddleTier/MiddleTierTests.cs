    ...
    public class MiddleTierTests : TestBase
    {
        ...
        public void MiddleTier_GetTableSpecialChars()
        {
            ...
            for (int i = 0; i < table.Rows.Count; i++)
            {
                ...
                {//last column is for DirtyString
        ...
        public void MiddleTier_GetPrimaryKeysFromInsert()
        {
            ...
            foreach (MethodInfo insertMethod in listInsertMethods)
            {
                ...
                #region Userods
                if (insertMethod.DeclaringType.Name == "Userods")
                {//Validation occurs. Must be called with unique username and one user group
                ...
                else if (insertMethod.DeclaringType.Name == "RegistrationKeys")
                {//Needs a field set to true to ensure a valid return.
                ...
                else if (insertMethod.DeclaringType.Name.In("Schedules", "Signalods"))
                {//Bulk inserts. Does not return or set primary keys. Skip
                    continue;
                }
                #endregion
                #region HQ Only Skip
