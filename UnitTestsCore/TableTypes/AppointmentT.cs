...
namespace UnitTestsCore
{
    public class AppointmentT
    {
        ...
        public static Appointment CreateAppointment(long patNum, DateTime aptDateTime, long opNum, long provNum, long provHyg = 0, string pattern = "//XXXX//"
            ...
            , long appointmentTypeNum = 0, long confirmed = 0, DateTime dateTimeAskedToArrive = default, string procDescript = "")
        {
    ...
    {//this can maybe be moved to appointments tests and made private. Same with the helper method. 
