...
namespace UnitTestsCore
{
    public class ProcedureCodeT
    {
        ...
        public static ProcedureCode CreateProcCode(string procCode, bool isCanadianLab = false, string abbrDesc = "", long procCat = 0, TreatmentArea treatmentArea = TreatmentArea.None, bool isTreatmentAreaAlsoToothRange = false, string descript = "", string procTime = "", string defaultNote = "", bool isHygiene = false, string medicalCode = "", string laymanTerm = "",
            long provNumDefault = 0, string taxCode = "", ToothPaintingType paintType = ToothPaintingType.None)
        {
        ...
        public static bool AddIfNotPresent(string procCode, bool isCanadianLab = false, string abbrDesc = "", long procCat = 0, ToothPaintingType toothPaintingType = ToothPaintingType.None, TreatmentArea treatmentArea = TreatmentArea.None, bool isTreatmentAreaAlsoToothRange = false, string descript = "", string procTime = "/X/", string defaultNote = "", bool isHygiene = false, string medicalCode = "",
            string laymanTerm = "", long provNumDefault = 0, string taxCode = "")
        {
