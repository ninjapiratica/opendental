...
namespace UnitTestsCore
{
    ...
    public class PharmacyT
    {
        ...
        public static long CreatePharmacy(string name, string addr, string city, string state, string zip, string phone)
        {
            long pharmacyNum = Pharmacies.Insert(new Pharmacy()
            {
                StoreName = name,
                Address = addr,
                City = city,
