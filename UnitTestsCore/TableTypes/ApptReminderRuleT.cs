...
namespace UnitTestsCore
{
    public class ApptReminderRuleT
    {
        public static ApptReminderRule CreateApptReminderRule(long clinicNum, ApptReminderType type, TimeSpan tsPrior,
            ...
            SendMultipleInvites sendMultipleInvites = SendMultipleInvites.UntilPatientVisitsPortal,
            TimeSpan timeSpanMultipleInvites = default(TimeSpan), bool isEnabled = true)
        {
            ...
            clinicRule.SendMultipleInvites = sendMultipleInvites;
            clinicRule.TimeSpanMultipleInvites = timeSpanMultipleInvites;
            ...
            clinicRule.IsEnabled = isEnabled;
